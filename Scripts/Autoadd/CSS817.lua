...
local Window = Library.CreateLib("CSS MENU V0.9","RJTheme2")
...
Section:NewButton("Old Test Zone (READ THREE DOT)", "Game do not have objects!!!", function()
local A_1 = 
{
	[1] = "Test", 
	[2] = 1, 
...
local Tab = Window:NewTab("Build Old Zones")
...
Section:NewButton("ForeverFire Channel:GameTester_4012", "", function()
end)