...
e1x1x1x1Message.Text = "8x8x8x8 Message"
...
e1x1x1x1Message.MouseButton1Down:connect(function()
	while true do
		...
		msg.Text = "8x8x8x8: MUHAWHAWHAW! NOOBS! I HAVE RETURNED FOR MY REVENGE!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "8x8x8x8: NOW YOU WILL ALL PARISH IN MY FIRE OF DOOM!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "8x8x8x8: I WILL DESTROY YOU ALL! YOU ARE WORTHLESS!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "8x8x8x8: YOU WILL NOT LIVE THROUGH MY DEADLY ATTACKS!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "8x8x8x8: I MIGHT AS WELL CLONE YOU INTO BOTS!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "8x8x8x8: AND THEN THOSE BOTS WILL DESTROY ROBLOX! HAHAHAHAHA!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "8x8x8x8: YOU CAN'T STOP ME! THERES NOTHING YOU CAN DO!"
		wait(6)
		msg:remove()
	end
end)
...
e1x1x1x1Music.Text = "8x8x8x8 Music"
...
e1x1x1x1Music.MouseButton1Down:connect(function()
	...
	s.Name = "Sound"
	s.SoundId = "http://www.roblox.com/asset/?id=1839289025"
	s.Volume = 1
	s.Pitch = 1
	s.Looped = true
	s.archivable = false
...
e1x1x1x1Laugh.Text = "8x8x8x8 Laugh"
