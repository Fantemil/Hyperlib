...
flyButton.Position = UDim2.new(0, 40, 0, 40) -- Top left corner with some padding
flyButton.Size = UDim2.new(0, 30, 0, 30) -- 30 pixels wide, 30 pixels high
flyButton.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Red background
flyButton.Text = ""
flyButton.TextColor3 = Color3.fromRGB(0, 0, 0) -- Black text
flyButton.TextSize = 14 -- Text size

-- Function to toggle flying
local isFlying = false
local function toggleFlying()
    isFlying = not isFlying
    game.Players.LocalPlayer.Character:FindFirstChildOfClass("Humanoid"):SetStateEnabled(Enum.HumanoidStateType.Flying, isFlying)
end

-- Connect the button to the toggleFlying function
