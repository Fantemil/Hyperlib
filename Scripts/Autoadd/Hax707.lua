...
Tab:AddButton({
    ...
    Callback = function()
        ...
        LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.tower.sections.finish.exit.carpet.CFrame + Vector3.new(0, 10, 0)
    end
})
...
Tab:AddButton({
	...
	Callback = function()
		...
		Settings.AntiFogConnection:Disconnect()
...
Settings.AntiFogConnection = game.Lighting:GetPropertyChangedSignal("FogEnd"):Connect(function()
    if Settings.AntiFog then
        game.Lighting.FogEnd = 1200
    end
end)
