...
title.Text = ("Undertale The Remnants of The Multiverse XTREME GUI")
title.Font = ("Arcade")
...
Speed_Finish.BorderColor3 = Color3.fromRGB(255, 255, 0)
Speed_Finish.Text = ("Farm EXP")
Speed_Finish.TextColor3 = Color3.fromRGB(255, 255, 0)
...
BSpeed_Finish.BorderColor3 = Color3.fromRGB(255, 250, 250)
BSpeed_Finish.Text = ("Farm Souls")
...
CSpeed_Finish.BorderColor3 = Color3.fromRGB(198, 85, 0)
CSpeed_Finish.Text = ("LoopKill Farm Bosses")
CSpeed_Finish.TextColor3 = Color3.fromRGB(218, 0, 95)
...
local num = 40000 -- change it whatever u want
for i = 1,num do
