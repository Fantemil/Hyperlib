...
do -- Example UI
	local Window = library:AddWindow("Furk - A Universal Time", {
		main_color = Color3.fromRGB(0, 0, 0),
		min_size = Vector2.new(260, 250),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
	...
	do -- Elements
		...
		Tab:AddButton("#1 Hub - Flamz", function()
			loadstring(game:HttpGet(("https://raw.githubusercontent.com/GodClass/EpicScripts/main/AUT%20GUI")))()
		end)
		Tab:AddButton("Balls Hub", function()
			loadstring(game:HttpGet(("https://raw.githubusercontent.com/johnbruhno/zzz/main/g")))()
		end)
		Tab:AddButton("Spotify Hub", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/ewyzu/Spotify-Scripts/main/A-Universal-Time"))()
		end)
		Tab:AddButton("Auto Quest GUI", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/madonchik123/AUTQuestMaker/main/main.lua"))()
		end)
				Tab:AddButton("God Mode", function()
