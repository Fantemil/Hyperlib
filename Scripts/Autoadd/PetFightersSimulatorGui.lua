loadstring(game:HttpGet("https://raw.githubusercontent.com/1201for/V.G_Hub_Extras/main/Universal_Client_Bypass"))() -- bypass cuz safe
...
ImageLabel.Image = "rbxassetid://7984243734"
...
Mobs = {}
for i, v in pairs(game:GetService("Workspace").GameAssets.Mobs:GetChildren()) do
    if v.ClassName == "Model" and v:FindFirstChild("Core") then
...
for i, v in pairs(game:GetService("Workspace").GameAssets.Capsules:GetChildren()) do
    if v.ClassName == "Model" and v:FindFirstChild("Capsule") then
        table.insert(Caps, v.Name)
        table.sort(Caps)
    end
end
...
local Tab1 = Window:CreateTab("Pet Fighters Simulator")
...
local Toggle1 = Section1:CreateToggle("Auto EquipBest", Settings.best, function(State)
Settings.best = State
while Settings.best do wait(getgenv().Delay)

game:GetService("ReplicatedStorage").Communication.Events.EquipBest:FireServer()
end end)
local Slider1 = Section1:CreateSlider("Equip Speed",0,5,nil,false, function(Value)
 getgenv().Delay = Value
end)

local Toggle1 = Section1:CreateToggle("Fast Attacks", Settings.fast, function(State)
Settings.fast = State
game:GetService("RunService").Stepped:connect(function()
if Settings.fast then
game:GetService("ReplicatedStorage").Communication.Events.ClickAttack:FireServer()
end end) end)
local Toggle1 = Section1:CreateToggle("Auto Collect Milestones", Settings.mile, function(State)
Settings.mile = State
while Settings.mile do wait(2)
game:GetService("ReplicatedStorage").Communication.Events.UpgradeMilestone:FireServer("Time Played")

game:GetService("ReplicatedStorage").Communication.Events.UpgradeMilestone:FireServer("Damage Done")

game:GetService("ReplicatedStorage").Communication.Events.UpgradeMilestone:FireServer("Capsules Opened")


game:GetService("ReplicatedStorage").Communication.Events.UpgradeMilestone:FireServer("Pets Discovered")
end end)


local Toggle1 = Section1:CreateToggle("Auto Collect", Settings.coins, function(State)
Settings.coins = State
workspace:WaitForChild("GameAssets"):WaitForChild("Coins").ChildAdded:Connect(
    function(c)
        if Settings.coins then
            game:GetService("ReplicatedStorage").Communication.Events.CollectCoin:FireServer(c)
        end
    end
)
end)
local Toggle1 = Section1:CreateToggle("Auto Attack Selected Mob", Settings.attack, function(State)
        ...
        function()
            repeat
                ...
                for i = 1, 50 do
                    wait()
                    game:GetService("ReplicatedStorage").Communication.Events.ClickAttack:FireServer()
                    game:GetService("ReplicatedStorage").Communication.Events.Attack:FireServer(
                        workspace.GameAssets.Mobs[Mobs],
                        false
                    )
                end
            until workspace.GameAssets.Mobs[Mobs].Core.MobOverhead.Frame.Health.Text == 0
        end
    )
end
...
local Toggle1 = Section1:CreateToggle("Auto Egg", Settings.dodo, function(State)
Settings.dodo = State
while Settings.dodo do
    wait()
    remote(
        game:GetService("ReplicatedStorage").Communication.Functions.OpenCapsules,
...
local Dropdown1 = Section1:CreateDropdown("Select Capsule")
Dropdown1:AddToolTip("Select Capsule")
for i,v in next, Caps do
Dropdown1:AddOption(v, function(String)
Caps = String
end)
end 
