...
local Window = Library.CreateLib("UBERAX SCRIPT MAD CITY V3", getgenv().Theme)
...
Section:NewButton("FAKE NAME", "FAKE NAME", function()

getgenv().name = "UberaX Hack V.i.P"
...
Section:NewButton("LAG FIX", "CONSOLE RESET", function()
...
-- local hack
local Tab = Window:NewTab("LOCAL HACK")

local Section = Tab:NewSection("LOCAL HACK")


Section:NewSlider("HITBOX", "Hitbox 35 Happens", 35, 0, function(hitboxsettup)
	
_G.HeadSize = hitboxsettup
_G.Disabled = true
...
Section:NewButton("ESP", "SIGNS NEARLY EVERYONE", function()

loadstring(game:HttpGet('https://raw.githubusercontent.com/Lucasfin000/SpaceHub/main/UESP'))()
end)


Section:NewButton("DOUBLE JUMP", "GIVES DOUBLE JUMP", function()
...
Section:NewButton("FARM MONEY", "TP BANK,DISCO,VB", function()

lloadstring(game:HttpGet("https://raw.githubusercontent.com/ProBaconHub/Mad-City-Script/main/MadAutoRob(NoServerHop)"))()

end)

local Tab = Window:NewTab("EXTRA GUI")

local Section = Tab:NewSection("EXTRA GUI")

Section:NewButton("FLY", "FLY GUİ", function()
...
Title = "UBERAX FLY GUI";
Text = "TELEGRAM- Uberax // INSTAGRAM - U.b.e.r.a.x";
...
Section:NewButton("ADMIN", "ADMIN  CONSOLE", function()

loadstring(game:HttpGet('https://raw.githubusercontent.com/FilteringEnabled/NamelessAdmin/main/Source'))()

end)

Section:NewButton("ANTI REPORT", "ADMIN,MOD KİCK ME", function()
...
for _,plr in next, players:GetPlayers() do
    ...
    for i,v in next, modvals do
        if status[v].Value == true and plr ~= players.LocalPlayer then
            players.LocalPlayer:Kick('ANTI REPORT ')
        end
    end
end
