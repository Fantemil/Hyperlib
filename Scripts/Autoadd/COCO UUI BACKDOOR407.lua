...
--Desc:Made by me,use this script to execute any script u want.
--Scripts Supports:Require,lua and loadstring 
...
MainFrame.BackgroundColor3 = Color3.fromRGB(130, 4, 11)
...
Min.MouseButton1Click:Connect(function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "Coco X";
        Text = "Coco X hide. Press F6 to back.";
        Duration = 2;
    })
    MainFrame.Visible = false
...
title.Text = "Coco UUI (Made by Rozxino)"
...
execute.MouseButton1Click:Connect(function()
    ...
    if injected == false then
        title.Text = "Coco UUi (Press Inject.)"
    end
end)
...
Attach.MouseButton1Click:Connect(function()
    if injected == true then
        title.Text = "Coco UUI - (Already injected!)"
        wait(1)
        title.Text = " Coco UUI Backdoor v8x"
    end
    if injected == false then
        title.Text = " Serious X - (Checking...)"
        wait(1)
        title.Text = "Serious X - (Finding backdoor...)"
        wait(2.5
        title.Text = "Serious X - (Checking Whitelist...)"
        wait(8)
        title.Text = "Serious X - (Scanning...)"
        wait(8)
        title.Text = "Serious X - (Injected)"
        wait(3)
        title.Text = "Coco UUI Backdoor v8x"
        injected = true
    end
...
title_3.Text = "Coco UUi - Script Hub"
...
title_5.Text = "Coco UUI - Options Menu"
...
synapsex3.Text = "Coco UUI Backdoor v8x"
...
synapsex3.MouseButton1Click:Connect(function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "Coco UUi";
        Text = "Coco UUi v13 coming soon.";
        Duration = 1;
    })
    synapsex3.Text = "Coming soon."
    wait(1)
    synapsex3.Text = "Coco UUi v13"
end)
...
while true do
    ...
    if scripthub_2.Visible == true then
        ...
        if scriptselected == "dex" then
            descri.Text = "A version of the popular Dex explorer with patches specifically for Fedora X."
        end
        if scriptselected == "esp" then
            descri.Text = "ESP used to show all players in the game."
        end
        if scriptselected == "spy" then
