...
TextButton_10.Text = "[Script Made By 09baRavenaaAlt]"
...
local function IVVUACL_fake_script() -- TextButton_8.Script 
	...
	m.Text = "Lol the game just got hacked XD"
	end
	script.Parent.MouseButton1Down:Connect(click)
end
