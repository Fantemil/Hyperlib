...
ANTI = hookmetamethod(game, "__namecall", function(SELF, ...)
    ...
    if not checkcaller() and SELF.Name == "RemoteEvent" and SELF.Parent.Name == "DetectLetter" and METHOD == "FireServer" then
        return print("haha, we can say the letter you bitch")
    end
