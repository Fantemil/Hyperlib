--[[
	ui-engine-v2
	version 1.3a
	by Spencer/Acer (Spencer) (Discord @ Acer#2666)
--]]
...
do -- Example UI
	local Window = library:AddWindow("Furk - Bedwars", {
		main_color = Color3.fromRGB(0, 0, 0),
		min_size = Vector2.new(340, 220),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
	...
	do -- Elements
		...
		Tab:AddLabel("Make sure you are in a match before executing!")
		
		Tab:AddButton("NEW - Future GUI", function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/joeengo/Future/main/loadstring.lua', true))()
		end)
		
		Tab:AddButton("OP - Vape Hub", function()
    		loadstring(game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/NewMainScript.lua", true))() 
		end)
    Tab:AddButton("Monkey Hub", function()
