--[[
	Elite-core-v3
	version 2.6a
	by Elite (Elite one) (Discord @ Elite one#4878)
--]]
			...
			function window_data:AddTab(tab_name)
				...
				do -- Tab Elements
					...
					function tab_data:AddKeybind(keybind_name, callback, keybind_options)
						...
						local shortkeys = { -- thanks to MTY for helping me out with this
...
do -- Example UI
	local Window = library:AddWindow("Elite - Sonic Speed Simulator", {
		main_color = Color3.fromRGB(0, 0, 0),
		min_size = Vector2.new(300, 220),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
	...
	do -- Elements
		...
		Tab:AddButton("Auto Collect GUI", function()
			loadstring(game:HttpGet("https://pastebin.com/raw/uKhVA8PN"))();
		end)
