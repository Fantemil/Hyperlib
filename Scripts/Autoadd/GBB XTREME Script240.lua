...
loadstring(game:HttpGet('https://raw.githubusercontent.com/XNEOFF/Shiftlock-Mobile/main/Shiftlock-Mobile.txt'))()
...
title.Text = ("Gaster Blaster Battles XTREME Gui")
title.Font = ("Arcade")
...
FSpeed_Finish.BorderColor3 = Color3.fromRGB(255, 0, 255)
...
FSpeed_Finish.Position = UDim2.new(0, 8, 0.45, 0)
FSpeed_Finish.Visible = true
...
gGSpeed_Finish.BorderColor3 = Color3.fromRGB(255,0,0)
gGSpeed_Finish.Text = ("AutoFarm Coins AND Soul Coins")
gGSpeed_Finish.TextColor3 = Color3.fromRGB(255,255,0)
gGSpeed_Finish.BackgroundColor3 = Color3.fromRGB(0,0,0)
gGSpeed_Finish.TextScaled = true
gGSpeed_Finish.Position = UDim2.new(0, 8, 0.25, 0)
gGSpeed_Finish.Visible = true
...
BSpeed_Finish.Text = ("Remove All Inside Anticheat, Unlock All best Characters, Remove Team Anti Cheat")
BSpeed_Finish.TextColor3 = Color3.fromRGB(0, 0, 255)
...
CSpeed_Finish.BorderColor3 = Color3.fromRGB(123, 0, 0)
CSpeed_Finish.Text = ("OMNI SANS")
CSpeed_Finish.TextColor3 = Color3.fromRGB(210, 0, 0)
...
DSpeed_Finish.Text = ("TP To Secret Soul ops Blaster Game")
...
DSpeed_Finish.Position = UDim2.new(0, 155, 0.45, 0)
...
local x = game.Players.LocalPlayer.Backpack["Wings Mode"]
while true do
wait(0.0001)
if x.Parent == game.Players.LocalPlayer.Character then game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 150 game.Workspace.Gravity = 20
elseif x.Parent == game.Players.LocalPlayer.Backpack then 
game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 40 game.Workspace.Gravity = 180
elseif game.Players.LocalPlayer.Character.Humanoid.Health == 0 then game.Workspace.Gravity = 180
...
Game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-545.601379, 349.537201, 208.798401, 0.0165752172, -0.0075673759, -0.999834061, 0.999775052, -0.013109684, 0.0166734457, -0.0132336915, -0.99988544, 0.00734829903)
wait(2)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(167.135544, 385.736267, 85.2346954, 0, 0, -1, 1, 0, 0, 0, -1, 0)
wait(2)
game.Players.LocalPlayer.Character.HumanoidRootPart. CFrame = CFrame.new(-545.103394, 367.988953, -41.8616066, -0.00267076492, 0.00595068932, -0.999978721, 0.999996424, 8.893013e-05, -0.00267034769, 7.30156898e-05, -0.999982297, -0.00595092773)
wait(2)


game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-545.862061, 385.390228, -341.514404, -0.000455141068, -0.0165103376, -0.999863625, 0.999999881, -2.7179718e-05, -0.000454753637, -1.96397305e-05, -0.999863625, 0.0165103078)
wait(2)


game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(168.113815, 385.300751, -198.050705, -0.000941038132, 0.0272669792, -0.999627709, 0.999999523, 4.529953e-06, -0.00094127655, -2.11298466e-05, -0.999628186, -0.0272669792)
wait(2)
...
-- This script was made by Francesco_miner with the help of the roblox BSter
...
game.Workspace.UnderSwapTeam.DustTrusttP5["Level 1 Door"]:Remove()
game.Workspace.UnderSwapTeam.DustTrusttP5.KillBrick:Remove()
for i= 1,4 do
game.Workspace.UnderSwapTeam.protection:Remove()
end




game.Workspace.HorrorTaleTeam.HorrorDut["Level 1 Door"]:Remove()
game.Workspace.HorrorTaleTeam.HorrorDut.KillBrick:Remove()
for i= 1,4 do
game.Workspace.HorrorTaleTeam.protection:Remove()
end



game.Workspace.KillerTaleTeam.KillerDust["Level 1 Door"]:Remove()
game.Workspace.KillerTaleTeam.KillerDust.KillBrick:Remove()
for i= 1,4 do
game.Workspace.KillerTaleTeam.protection:Remove()
end




game.Workspace.UnderFellTeam.INFF["Level 1 Door"]:Remove()
game.Workspace.UnderFellTeam.INFF.KillBrick:Remove()
for i= 1,4 do
game.Workspace.UnderFellTeam.protection:Remove()
end
...
game.Workspace.UnderTaleTeam.Glitch["Level 1 Door"]:Remove()
game.Workspace.UnderTaleTeam.Glitch.KillBrick:Remove()
for i= 1,4 do
game.Workspace.UnderTaleTeam.protection:Remove()
end




game.Workspace.HRWALLS:Remove()
game.Workspace.UFWALLS:Remove()
game.Workspace.USWALLS:Remove()
game.Workspace.UTWALLS:Remove()
game.Workspace.KLWALLS:Remove()
end)
