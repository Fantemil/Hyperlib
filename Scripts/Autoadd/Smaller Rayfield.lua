...
TabList.Position = UDim2.new(0.5, 0, 0, 70)
Elements.Size = UDim2.new(0, 475, 0, 200)
Elements.Position = UDim2.new(0.5, 0, 0.65, 0)
	...
	function Window:CreateTab(Name,Image)
		...
		TabButton.Interact.MouseButton1Click:Connect(function()
			...
			if Elements.UIPageLayout.CurrentPage ~= TabPage then
				TweenService:Create(Elements, TweenInfo.new(1, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 460, 0, 200)}):Play()
				Elements.UIPageLayout:JumpTo(TabPage)
				wait(0.2)
				TweenService:Create(Elements, TweenInfo.new(0.8, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 475, 0, 200)}):Play()
			end
...
function RayfieldLibrary:Toggle()
	if Debounce then return end
	if Hidden then
		Hidden = false
		Minimised = false
