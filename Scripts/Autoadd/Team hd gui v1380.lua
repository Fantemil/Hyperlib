...
ImageLabel.Image = "http://www.roblox.com/asset/?id=16704086489" -- Background image ID
...
createButton("Decal Spam", UDim2.new(0.35, 0, 0.2, 0), function(ID)
