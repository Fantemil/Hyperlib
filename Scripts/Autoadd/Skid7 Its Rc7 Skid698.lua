...
-- Instances:
game:GetService("StarterGui"):SetCore("SendNotification",{  Title = "Skid7",      
...
Skid7.Name = "Skid7"
Skid7.Parent = game.CoreGui
Skid7.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
submit.MouseButton1Down:connect(function()
    if pass.Text == "FEBYPASS" then
        passpage.Visible = false
        mainpage.Visible = true
    else
        pass.Text = "TYPE "FEBYPASS"!"
        wait(2)
        pass.Text = ""
    end
end)
