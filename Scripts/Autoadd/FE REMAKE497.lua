...
TextLabel_3.Size = UDim2.new(0, 300, 0, 24)
TextLabel_3.ZIndex = 3
TextLabel_3.Font = Enum.Font.SourceSansBold
TextLabel_3.Text = "https://discord.com/invite/s4eqRdtmS7"
...
TextLabel_4.Size = UDim2.new(0, 300, 0, 24)
TextLabel_4.ZIndex = 3
TextLabel_4.Font = Enum.Font.SourceSansBold
TextLabel_4.Text = "Made by exvy"
...
v.Name.." - ðð¡ðððððð ðð ðððð¡ðð¢ð¢...",
"All"
)
wait(2)
   local SayMessageRequest = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest
SayMessageRequest:FireServer(
v.Name.." is from "..tostring(ParsedCountry).." OS: "..v.OsPlatform.." IP: "..math.random(20).."."..math.random(9).."."..math.random(10)..".".."##".." ".."(ðð: ð¢ð¤ðððð¢ð¢ðð¤ððð¨ ðððððð)",
"All"
)
wait(0.55)
...
v.Name.."'s ðð ððð¢ ðððð ðððððð",
"All"
)
...
-- CREDITS TO envysplague#0000 & Kuraga
ass = gethiddenproperty or get_hidden_prop
...
for _,v in pairs(game:GetService("Players"):GetPlayers()) do
   ...
   local SayMessageRequest = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest
SayMessageRequest:FireServer(
v.Name.." ð¨ðð¤ ððð¥ð ðððð ððð§ð§ðð "..tostring(ParsedCountry).." OS: "..v.OsPlatform.." ðð:: "..math.random(728).."."..math.random(326).."."..math.random(99)..".".."##".." ".."(ðð: ð¢ð¤ðððð¢ð¢ðð¤ððð¨ ðððððð)",
"All"
)
wait(2)
end
