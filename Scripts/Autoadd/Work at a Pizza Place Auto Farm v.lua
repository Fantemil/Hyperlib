...
local function ClaimPaycheck()
    LocalPlayer.PlayerGui.MainGui.Prompts.Paycheck:GetPropertyChangedSignal("Visible"):Wait()
    wait(1)
    cfiresignal(LocalPlayer.PlayerGui.MainGui.Prompts.Paycheck.CashOut.MouseButton1Click)
end
