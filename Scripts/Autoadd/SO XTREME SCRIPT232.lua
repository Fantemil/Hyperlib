...
local GDDGSpeed_Finish = Instance.new("TextButton")
local GDUDGSpeed_Finish = Instance.new("TextButton")
wait(0)
...
title.Text = ("Soul Ops XTreme Gui")
title.Font = ("Arcade")
...
Speed_Finish.Text = ("HALLOWEEN EVENT")
...
DSpeed_Finish.Text = ("Heal Aura (Need Heal Blaster)")
...
BSpeed_Finish.Text = ("Afk/Spam Use Tools")
...
CSpeed_Finish.BorderColor3 = Color3.fromRGB(98, 0, 0)
CSpeed_Finish.Text = ("Dust Error")
CSpeed_Finish.TextColor3 = Color3.fromRGB(38, 0, 57)
...
GDGSpeed_Finish.Visible = true
GDGSpeed_Finish.Font = ("Arcade")



GDDGSpeed_Finish.Parent = gui.MainFrame
GDDGSpeed_Finish.Name = ("FUCKalreal")
GDDGSpeed_Finish.Size = UDim2.new(0.25, 0, 0.15, 0)
GDDGSpeed_Finish.BackgroundTransparency = 0.5
GDDGSpeed_Finish.BorderSizePixel = 3
GDDGSpeed_Finish.BorderColor3 = Color3.fromRGB(120,120,255)
GDDGSpeed_Finish.Text = ("Freeze Enemies")
GDDGSpeed_Finish.TextColor3 = Color3.fromRGB(120,120,255)
GDDGSpeed_Finish.BackgroundColor3 = Color3.fromRGB(0,0,0)
GDDGSpeed_Finish.TextScaled = true
GDDGSpeed_Finish.Position = UDim2.new(0, 671, .32, 0)
GDDGSpeed_Finish.Visible = true
GDDGSpeed_Finish.Font = ("Arcade")

GDUDGSpeed_Finish.Parent = gui.MainFrame
GDUDGSpeed_Finish.Name = ("FUCKalreal")
GDUDGSpeed_Finish.Size = UDim2.new(0.25, 0, 0.15, 0)
GDUDGSpeed_Finish.BackgroundTransparency = 0.5
GDUDGSpeed_Finish.BorderSizePixel = 3
GDUDGSpeed_Finish.BorderColor3 = Color3.fromRGB(120,0,0)
GDUDGSpeed_Finish.Text = ("Make Enemies Slide")
GDUDGSpeed_Finish.TextColor3 = Color3.fromRGB(120,0,0)
GDUDGSpeed_Finish.BackgroundColor3 = Color3.fromRGB(0,0,0)
GDUDGSpeed_Finish.TextScaled = true
GDUDGSpeed_Finish.Position = UDim2.new(0, 671, .5, 0)
GDUDGSpeed_Finish.Visible = true
GDUDGSpeed_Finish.Font = ("Arcade")
...
GGGSpeed_Finish.Text = ("LoopKill all Bosses/Charas/Enemies")
...
tool.Name = "Master Of Destruction"
...
tool.Parent = game.Players.LocalPlayer.Backpack
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(8120.19873, 772.497803, -5331.38867, 1.56164169e-05, 0.0184780955, 0.999829292, 0.999999464, -0.00104188919, 3.63588333e-06, 0.00104176998, 0.999828756, -0.0184781551)
	wait(10)
	local Blast = game.Players.LocalPlayer.Backpack["Error Blaster"]
	game.Players.LocalPlayer.Backpack["Error Blaster"].Name = ("Dusted Error Blaster")
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(8026.79932, 772.514954, -5331.32617, 9.47713852e-06, 0.0191621184, 0.999816418, 0.999999464, -0.00103521347, 1.03712082e-05, 0.00103524327, 0.999815881, -0.019162178)
	wait(4)
	game.Players.LocalPlayer.Character.Headz.Eye:Remove()
	game.Players.LocalPlayer.Character.Headz.Eye:Remove()
	game.Players.LocalPlayer.Character.Headz.LowSkull:Remove()
	game.Players.LocalPlayer.Character.Headz.Nose:Remove()
	game.Players.LocalPlayer.Character.Headz.UpSkull:Remove()
	game.Players.LocalPlayer.Character.Headz.Teeth:Remove()
	game.Players.LocalPlayer.Character.Chest.Part.Name = ("String")
	game.Players.LocalPlayer.Character.Chest.Part:Remove()
	game.Players.LocalPlayer.Character.Chest.Part:Remove()
	game.Players.LocalPlayer.Character.Chest.Part.Name = ("String")
	game.Players.LocalPlayer.Character.Chest.Part.Name = ("String")
	game.Players.LocalPlayer.Character.Chest.Part:Remove()
	game.Players.LocalPlayer.Backpack.Teleport.Name = ("Dusting Teleport")
...
game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 48
	Blast.Activated:Connect(function()
		wait(0.6)
		game.Workspace.ErrorBlaster.BallOfInst.Color = Color3.fromRGB(63, 0, 95)
		game.Workspace.ErrorBlaster.Eye.Color = Color3.fromRGB(255, 0, 0)
		game.Workspace.ErrorBlaster.Eye2.Color = Color3.fromRGB(255, 0, 0)
		game.Workspace.ErrorBlaster.InnerEye.Material = ("Neon")
		game.Workspace.ErrorBlaster.Inst.Color = Color3.fromRGB(69, 0, 103)
		game.Workspace.ErrorBlaster.Inst.Size = Vector3.new(400, 40, 40)
		wait(0.1)
		game.Workspace.ErrorBlaster.Inst.Size = Vector3.new(400, 40, 40)
		wait(0.1)
		game.Workspace.ErrorBlaster.Inst.Size = Vector3.new(400, 40, 40)
...
while true do 
wait(0.001)
game.Workspace.MiniGasterBlaster3.Inst.Position = game.Players.LocalPlayer.Character.Torso.Position
...
GDDGSpeed_Finish.MouseButton1Click:Connect(function()
sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", 112412400000)
        sethiddenproperty(game.Players.LocalPlayer, "MaxSimulationRadius", 112412400000)
        for i,d in pairs(game:GetService("Workspace"):GetDescendants()) do
            if d.ClassName == 'Humanoid' and d.Parent.Name ~= game.Players.LocalPlayer.Name then
...
GDUDGSpeed_Finish.MouseButton1Click:Connect(function()
sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", 112412400000)
        sethiddenproperty(game.Players.LocalPlayer, "MaxSimulationRadius", 112412400000)
        for i,d in pairs(game:GetService("Workspace"):GetDescendants()) do
            if d.ClassName == 'Humanoid' and d.Parent.Name ~= game.Players.LocalPlayer.Name then
               d.WalkSpeed = 75747474774848472378
d.JumpPower = 0
            end
        end
end)
