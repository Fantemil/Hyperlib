_G.Magnet = "" -- type the name of the magnet you want to autoequip or autobuy
_G.Backpack = "" -- type the name of the backpack you want to autoequip or autobuy
_G.Pet = "Shiny Bat Bear" -- type the name of the pet you want to autoequip
 
--[[ Examples:
Pets ~ "Bear" "Panda" "Koala" "Spirit Bear"
Magnets ~ "Silver Magnet" "Majestic Magnet" "Adurite Magnet"
Backpacks ~ "Diamond Magnet Pack" "Advanced Backpack" "Adurite Backpack"
--]]
 
BuyBackpack = true --set this true if you want to buy the magnet
BuyMagnet = false --set this to true if you want to buy the magnet
...
Game.Text = "Magnet Sim" -- Game name here
...
B2.Text = "AutoSell"
B3.Text = "AutoRebirth"
B4.Text = "AutoEquip (Top of code)"
B5.Text = "AutoBuy (Top of code)"
B6.Text = "AutoMoney+"
...
while _G.on2 == 1 do
game:GetService('RunService').Stepped:wait()
Root.CFrame = CFrame.new(136.73712158203, 13.362461090088, -52.908908843994)
wait()
Root.CFrame = CFrame.new(136.83712158203, 13.362461090088, -52.908908843994)
wait()
end
Root.CFrame = orgin
end
