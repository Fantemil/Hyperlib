...
jumpscare2.Text = "bre4dkidd jumpscare"
...
local function HDTLA_script() -- skybox.Script 
	...
	function click()
		...
		s.SkyboxBk = "http://www.roblox.com/asset/?id=12582150185"
		s.SkyboxDn = "http://www.roblox.com/asset/?id=12582150185"
		s.SkyboxFt = "http://www.roblox.com/asset/?id=12582150185"
		s.SkyboxLf = "http://www.roblox.com/asset/?id=12582150185"
		s.SkyboxRt = "http://www.roblox.com/asset/?id=12582150185"
		s.SkyboxUp = "http://www.roblox.com/asset/?id=12582150185"
...
local function HNSKCE_script() -- particlesspam.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		for i, v in pairs(game.Players:GetChildren()) do
			...
			emit.Texture = "http://www.roblox.com/asset/?id=12582150185"
	...
	function click()
		function exPro(root)
			for _, v in pairs(root:GetChildren()) do
				if v:IsA("Decal") and v.Texture ~= "http://www.roblox.com/asset/?id=12582150185" then
					v.Parent = nil
				elseif v:IsA("BasePart") then
					...
					One.Texture = "http://www.roblox.com/asset/?id=12582150185"
					Two.Texture = "http://www.roblox.com/asset/?id=12582150185"
					Three.Texture = "http://www.roblox.com/asset/?id=12582150185"
					Four.Texture = "http://www.roblox.com/asset/?id=12582150185"
					Five.Texture = "http://www.roblox.com/asset/?id=12582150185"
					Six.Texture = "http://www.roblox.com/asset/?id=12582150185"
					One.Face = "Front"
					Two.Face = "Back"
					Three.Face = "Right"
					Four.Face = "Left"
		...
		for i,v in pairs(game.Players:GetPlayers()) do
			if v.Name ~= me and not v.PlayerGui:FindFirstChild("Screamer") and v:FindFirstChild("PlayerGui") then
				spawn(function()
					...
					newgui.Name = "Screamer"
					local newimage = Instance.new("ImageLabel",newgui)
					newimage.Image = "http://www.roblox.com/asset/?id=12959294525"
					newimage.Size = UDim2.new(1,1,1,1)
					local s = Instance.new("Sound",newgui)
					s.SoundId = "rbxassetid://9069609200"
					s.Volume = 9999999999999999999999999999999999999
...
local function KFEZLAS_script() -- hint.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		m.Text = "team bre4dkidd join today!"
	end)
end
