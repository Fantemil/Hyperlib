...
title.Text = ("Sans Tycoons Of Chaos XTREME Gui")
title.Font = ("Arcade")
...
Speed_Finish.Name = ("TP To Error Sans")
Speed_Finish.Size = UDim2.new(0.25, 0, 0.15, 0)
Speed_Finish.BackgroundTransparency = 0.1
Speed_Finish.BorderSizePixel = 3
Speed_Finish.BorderColor3 = Color3.fromRGB(0, 0, 255)
Speed_Finish.Text = ("Steal All Tools")
Speed_Finish.TextColor3 = Color3.fromRGB(255, 0, 0)
...
DSpeed_Finish.BorderColor3 = Color3.fromRGB(185, 0, 255)
DSpeed_Finish.Text = ("Auto Collect Everyone's Cash")
...
BSpeed_Finish.BorderColor3 = Color3.fromRGB(55, 50, 50)
BSpeed_Finish.Text = ("Melee Hitbox")
BSpeed_Finish.TextColor3 = Color3.fromRGB(50,50, 50)
...
CSpeed_Finish.BorderColor3 = Color3.fromRGB(198, 0, 0)
CSpeed_Finish.Text = ("Kill all boss/npc")
CSpeed_Finish.TextColor3 = Color3.fromRGB(218, 0, 5)
...
ESpeed_Finish.Text = ("TP To The Trial")
...
FSpeed_Finish.Text = ("TP To Christmas Event")
...
GSpeed_Finish.Text = ("TP To / Beat Ainavol event")
...
GGSpeed_Finish.Text = ("Custom Characters")
...
GGGGSpeed_Finish.Text = ("FREE DELTA SANS ADMIN CHAR")
...
gGSpeed_Finish.Text = ("TP To Soul Ops Event")
...
local level1Id = 11885508640 -- Change "0" to the place ID
...
for i,v in pairs (game.Workspace["Thor tycoon KIT"]["Zednov's Tycoon Kit [OPEN!]"]["Tycoons"]:GetChildren()) do
wait()
for i,b in pairs (v.Essentials:GetChildren()) do
if b.Name == ("Giver") then
b.Position = game.Players.LocalPlayer. Character.HumanoidRootPart. Position
end
...
local TeleportService = game:GetService("TeleportService")
local level1Id = 11774687106 -- Change "0" to the place ID
...
GSpeed_Finish.MouseButton1Click:Connect(function()
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-657.741211, 2.507967, -737.107849, 1, 0, 0, 0, 1, 0, 0, 0, 1)
	wait(6)

local TeleportService = game:GetService("TeleportService")
local level1Id = 12013746980 -- Change "0" to the place ID
...
local TeleportService = game:GetService("TeleportService")
local level1Id = 12580361887 -- Change "0" to the place ID
...
game.Players.LocalPlayer.Character.HumanoidRootPart. CFrame = CFrame.new(-3619.97827, -2.85866404, -5124.70068, 0.241847098, 0, 0.970314562, 0, 1, 0, -0.970314562, 0, 0.241847098)

end)

GDGSpeed_Finish.MouseButton1Click:Connect(function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-3607.91479, -3.04924107, -5124.05566, 1.00135803e-05, 0.342006564, -0.939697623, 1, -1.00135803e-05, 7.00354576e-06, -7.00354576e-06, -0.939697623, -0.342006564)
end)

GGGGSpeed_Finish.MouseButton1Click:Connect(function()
game.Players.LocalPlayer.Character.HumanoidRootPart. CFrame = CFrame.new(-3389.79565, -1.4477396, -5128.60596, -1.00135803e-05, 0.342006564, -0.939697623, 1, 1.00135803e-05, -7.00354576e-06, 7.00354576e-06, -0.939697623, -0.342006564)
