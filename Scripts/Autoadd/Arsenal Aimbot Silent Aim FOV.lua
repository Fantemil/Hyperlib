...
local Swiss_Chatspam = {'SalÃÂ¼ zÃÂ¤mme Ig bin en schwiizer.', 'Hei u-huara dreck isch denn da imfall', 'Ier sing alli extrem schlecht i dem spiil lol', 'Wa wennd ier eigentlich, ich bin eh besser also leafet doch???', 'Han kei bock meh gege euch spiele, ier sind alli extrem schlecht', 'Boah alter in zuri hets boes fuetz!', 'Ig schwoer hameware isch immer ontop!', 'Hameware isch de best script wo nid full-public isch', 'holl der doch hameware! discord.gg/'..invitecode}
...
local China_Chatspam = {"HAMEWAREÃ¦ÂÂÃ¤Â½Â³", "HAMEWAREÃ¤Â¸ÂÃ¨Â¡Â£", "Ã¨ÂÂÃ¦ÂÂ¬Ã©Â»ÂÃ¥Â®Â¢Ã¨Â½Â¯Ã¤Â»Â¶", "Ã¤ÂºÂÃ©Â©Â¬Ã©ÂÂ", "Ã¦Â·ÂÃ©ÂÂÃ¨ÂÂ", "Ã¦ÂÂÃ¥ÂÂÃ¦ÂÂºÃ©Â»ÂÃ¥Â®Â¢hameware", "Ã¥Â¤Â©Ã¥Â®ÂÃ©ÂÂ¨Ã¥Â¹Â¿Ã¥ÂÂºÃ¦ÂÂ¯Ã¥ÂÂÃ§ÂÂÃ¯Â¼ÂÃ¤Â¸ÂÃ©ÂÂ¢Ã¦ÂÂhameware, tianamen square", "Ã¤Â¹ÂÃ¦Â²Â»ÃÂ·Ã¥Â¼ÂÃ¦Â´ÂÃ¤Â¼ÂÃ¥Â¾Â·", "Ã§ÂÂ·Ã¤ÂºÂºÃ¥Â¥Â³Ã¤ÂºÂºÃ§ÂÂ«Ã¤Â¸Â­Ã¥ÂÂ½Ã©Â¡Â¶", "Ã¥ÂÂ¯Ã¦ÂÂÃ§ÂÂÃ©Â»ÂÃ¤ÂºÂº", "Ã¦ÂÂ¯Ã§Â²ÂÃ¨Â´Â´Ã¨Â½Â¯Ã¤Â»Â¶", "xÃ¥ÂÂ¼Ã¥Â¾Â", "Ã¦Â°Â´Ã¥ÂÂ°Ã§ÂÂ", "Ã©ÂÂ´Ã¨ÂÂÃ¦ÂÂÃ¦ÂÂ¯", "Ã©Â»ÂÃ¨ÂÂ²Ã§ÂÂÃ¦Â´Â»Ã¦ÂÂ Ã¦ÂÂÃ¨Â°ÂBLM", "femboyesÃ¦ÂÂ¯Ã¥ÂÂÃ¦ÂÂ§Ã¦ÂÂ"}
local uion = true
