...
title.Text = ("Undertale Unbalanced Sans AUs Battles XTREME GUI")
title.Font = ("Arcade")
...
Speed_Finish.TextColor3 = Color3.fromRGB(0, 0, 255)
...
DSpeed_Finish.BorderColor3 = Color3.fromRGB(155, 255, 50)
DSpeed_Finish.Text = ("Get All Tools")
DSpeed_Finish.TextColor3 = Color3.fromRGB(155, 255, 50)
...
BSpeed_Finish.BorderColor3 = Color3.fromRGB(66, 255, 66)
BSpeed_Finish.Text = ("Free Goblin Sans")
BSpeed_Finish.TextColor3 = Color3.fromRGB(66,255, 66)
...
CSpeed_Finish.Text = ("Free Imposter Sans")
...
x.Parent = workspace
x.Position = Vector3.new(53.3426, 0.1836, -28.7685)
x.Anchored = true
...
local x = Instance.new("Part")
x.Parent = workspace
x.Position = Vector3.new(53.3426, 0.1836, -12.2167)
x.Anchored = true
