...
local Window = Library.CreateLib("CSS MENU V1.4.0 Beta","RJTheme6")
...
Section:NewButton("House Zone Act 1", "ButtonInfo", function()
local A_1 = 
{
	[1] = "House", 
	[2] = 2, 
...
Section:NewButton("Lag Server!", "Click This! And Lag Server!", function()
...
local Tab = Window:NewTab("Replacing Textures")
local Section = Tab:NewSection("Replace All Textures")
Section:NewButton("Basic Textures", "Replace Textures!", function()
...
local Tab = Window:NewTab("Unused Music")
local Section = Tab:NewSection("Music Intro:")
...
local Section = Tab:NewSection("Music Loop:")
...
Section:NewButton("Script Make ForeverFire And Coco Man", "Or temakuzurin and superkirill20111", function()
end)
