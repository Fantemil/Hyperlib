...
local Window = Rayfield:CreateWindow({
   Name = "ð¥ z4trox hub| Game ð«",
   LoadingTitle = "waiting the script loading",
   LoadingSubtitle = "by z4trox",
   ConfigurationSaving = {
      Enabled = false,
   ...
   KeySettings = {
      Title = "Key | z4trox Hub",
      Subtitle = "Key System",
      Note = "Key in scripblox",
      ...
      Key = {"https://pastebin.com/raw/vCrZt6kv"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
