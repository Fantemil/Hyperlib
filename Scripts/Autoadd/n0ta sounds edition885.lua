...
theme.MouseButton1Down:Connect(function()
  local sound = Instance.new("Sound",game.Workspace)
  sound.Name = "H4xed By not4player214"
  sound.SoundId = "rbxassetid://6954025463"
  sound.Volume = 999999999999999999999
  sound.PlaybackSpeed = 0.9
  sound:Play()
end)
...
shut.MouseButton1Down:Connect(function()
  local sound = Instance.new("Sound",game.Workspace)
  sound.Name = "H4xed By not4player214"
  sound.SoundId = "rbxassetid://7117070061"
  sound.Volume = 999999999999999999999
  sound.PlaybackSpeed = 0.9
  sound:Play()
end)
...
sky.MouseButton1Down:Connect(function()
  local sound = Instance.new("Sound",game.Workspace)
  sound.Name = "H4xed By not4player214"
  sound.SoundId = "rbxassetid://13530436461"
  sound.Volume = 999999999999999999999
  sound.PlaybackSpeed = 0.9
  sound:Play()
end)
...
unanchor.MouseButton1Down:Connect(function()
  local sound = Instance.new("Sound",game.Workspace)
  sound.Name = "H4xed By not4player214"
  sound.SoundId = "rbxassetid://6868100434"
  sound.Volume = 999999999999999999999
  sound.PlaybackSpeed = 0.9
  sound:Play()
end)
