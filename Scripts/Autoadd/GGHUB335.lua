...
local Window = Library.CreateLib("GGHUB [beta]", "Ocean")
...
-- Oyuncu listesi oluÃâ¦ÃÂ¸turma
local players = game.Players:GetPlayers()
for i, player in ipairs(players) do
    -- Her oyuncu iÃÆÃÂ§in teleport dÃÆÃÂ¼ÃâÃÂ¸mesi oluÃâ¦ÃÂ¸turma
...
-- Oyuncu zÃâÃÂ±plama gÃÆÃÂ¼cÃÆÃÂ¼ ayarlayan kaydÃâÃÂ±rÃâÃÂ±cÃâÃÂ±
PlayerSection:NewSlider("JumpPower", "Adjust your jump power", 250, 50, function(value)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = value
end)

-- UyarÃâÃÂ± veren dÃÆÃÂ¼ÃâÃÂ¸me eklemek
