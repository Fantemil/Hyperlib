...
title.Text = ("UNDERTALE BATTLE ROYALE XTREME GUI")
title.Font = ("Arcade")
...
Speed_Finish.Text = ("Remove Cooldowns from ALL Placeable attacks")
Speed_Finish.TextColor3 = Color3.fromRGB(85, 255, 85)
...
DSpeed_Finish.BorderColor3 = Color3.fromRGB(85, 255, 255)
DSpeed_Finish.Text = ("Kill Any Boss/Event")
DSpeed_Finish.TextColor3 = Color3.fromRGB(85, 255, 255)
...
CSpeed_Finish.Text = ("Teleport To Nightmare Event")
CSpeed_Finish.TextColor3 = Color3.fromRGB(125, 67, 5)
...
ESpeed_Finish.Text = ("Teleport To HyperDust Event")
...
local level1Id = 12979426599 -- Change "0" to the place ID
...
local TeleportService = game:GetService("TeleportService")
local level1Id = 6597970288 -- Change "0" to the place ID
...
game.Workspace.Lobby.SpawnLocation.Position = game.Players.LocalPlayer.Character.HumanoidRootPart. Position	
