...
local KITSU_settings = {
    AutoFarm = {
        ...
        AI_Capture = false, -- if you want to better the script keep this on. * this wont log any type of personal information, it will only log your players conditions every time your console errors then remember to not do that
        AutoStats = {
            ['Melee'] = false,
            ['Defense'] = false,
            ['Sword'] = false,
...
};getgenv().Banana=KITSU_settings  ;if Loaded then return end;getgenv().Loaded=true;
