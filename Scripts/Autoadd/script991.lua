...
local vapeAssetTable = {
	...
	["vape/assets/VapeLogo2.png"] = "rbxassetid://14037438801",
	["vape/assets/VapeLogo4.png"] = "rbxassetid://14037438801"
}
...
VapeLogo.Position = UDim2.new(1, -138, 0, 3)
...
VapeLogoV4.Size = UDim2.new(0, 33, 0, 33)
VapeLogoV4.Name = "Logo2"
VapeLogoV4.Position = UDim2.new(1, 2, 0, -2)
...
local owners = {
	["da3ishmember"] = 4798834838,
	["MeWhenScytheDisabler"] = 4825635988
}
...
TargetInfoMainInfo.BackgroundColor3 = Color3.new(0.92,0.92,0.92)
TargetInfoMainInfo.Size = UDim2.new(0, 235, 0, 80)
...
TargetInfoName.TextColor3 = Color3.fromRGB(0, 0, 0)
TargetInfoName.Position = UDim2.new(0, 115, 0, 8)
TargetInfoName.TextStrokeTransparency = 1
TargetInfoName.BackgroundTransparency = 1
TargetInfoName.Size = UDim2.new(0, 80, 0, 20)
TargetInfoName.Text = "this dead nigga"
TargetInfoName.ZIndex = 2
TargetInfoName.TextXAlignment = Enum.TextXAlignment.Center
...
TargetInfoNameShadow.TextTransparency = 1
TargetInfoNameShadow.TextColor3 = Color3.new()
TargetInfoNameShadow.ZIndex = 1
TargetInfoNameShadow.Position = UDim2.new(0, 0.5, 0, 0.5)
...
TargetInfoHealthBackground.BackgroundColor3 = Color3.fromRGB(32, 32, 32)
TargetInfoHealthBackground.Size = UDim2.new(0, 145, 0, 4)
TargetInfoHealthBackground.Position = UDim2.new(0, 84, 0, 29)
...
TargetInfoHealthBackgroundShadow.Position = UDim2.new(0.5, 0, 0.5, 6)
...
TargetInfoHealthBackgroundShadow.ImageTransparency = 1
TargetInfoHealthBackgroundShadow.ZIndex = -1
TargetInfoHealthBackgroundShadow.Size = UDim2.new(1, 6, 1, 6)
TargetInfoHealthBackgroundShadow.ImageColor3 = Color3.fromRGB(255, 255, 255)
...
TargetInfoImage.Size = UDim2.new(0, 70, 0, 70)
...
TargetInfoBackground = TargetInfo.CreateToggle({
	...
	Function = function(callback) 
		...
		TargetInfoName.TextColor3 = callback and Color3.fromRGB(23, 23, 23) or Color3.fromRGB(12, 12, 12)
		TargetInfoName.Size = UDim2.new(0, 80, 0, callback and 18 or 18)
		TargetInfoName.TextSize = callback and 17 or 17
		TargetInfoHealthBackground.Size = UDim2.new(0, 145, 0, callback and 11 or 11)
	end,
	Default = true
})
