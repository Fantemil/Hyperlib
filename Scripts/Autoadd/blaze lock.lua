...
NotifyLib.prompt('blzlock- Q To Lock', 'Loading..', 5)
NotifyLib.prompt('Sets Loaded', 'Start SonningðŸ”¥', 5)
NotifyLib.prompt('blaze.lock', 'u suck btw ;)', 5)
