...
Â function makemarker(Parent, Adornee, Color, Size, Size2)
...
Â local data = game.Players:GetPlayers()
...
Â 	local TextLabel = Instance.new("TextLabel", handler)
...
Â game.Players.PlayerAdded:connect(function(Player)
    noob(Player)
end)
Â game.Players.PlayerRemoving:Connect(function(player)
...
Â mouse.KeyDown:Connect(function(k)
...
Â function getClosestPlayerToCursor()
    local closestPlayer
    local shortestDistance = math.huge
Â     for i, v in pairs(game.Players:GetPlayers()) do
...
Â 	game:GetService"RunService".Stepped:connect(function()
...
Â 	local mt = getrawmetatable(game)
