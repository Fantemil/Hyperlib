if game.CoreGui:FindFirstChild("Mana") then
  ...
  function VLib:Window(text, textgame, textcircle)
   ...
   LeftFrame.Size = UDim2.new(0, 180, 0, 410)
   ...
   TabHolder.Size = UDim2.new(0, 150, 0, 305)
   ...
   function Tabs:Tab(text)
      ...
      Container.Size = UDim2.new(0, 4200, 0, 379)
...
-- ALL TABS --
   local Win = VLib:Window("Manahub", "Pet Fighters")
...
game:GetService("ReplicatedStorage").Communication.Events.EquipBest:FireServer()
   ...
   Autofarm:Button("Disable coins popup", function()
    game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.PopUps.Coins:Destroy()
   end)

   Autofarm:Toggle("Auto Equip Best Pets", false, function(t)
equip = t
...
table.insert(mob, v.Name)
   ...
   Autofarm:Dropdown("Select mob", mob, function(a)
    selectmob = a
   end)



   Autofarm:Toggle("Fram Selected mob", false, function(t)
attack = t
...
table.insert(selegg, v.Name)
   ...
   Egg:Dropdown("Select Egg", selegg, function(a)
    selectegg = a
   end)

   Egg:Toggle("Auto Open Selected Egg", false, function(t)
open = t
...
-- Mana has comited sucide --

-- Better luck next time -- 

-- i know i did a sluby job but it works so fack u --

-- fell free do do more cause im dead --
               ...
               Autofarm:Dropdown("Select Quest [Beta]", Quest, function(a)
                _G.selectquest = a
               end)
            
               Autofarm:Button("Start Auto Quest [Beta]", function(t)
...
for i = 1,5 do
    ...
    loadstring(game:HttpGet("https://www.toptal.com/developers/hastebin/raw/izuyepewuz"))()
               ...
               Autofarm:Toggle("Auto Collect Coins", false, function(t)
            collect = t
            while collect do task.wait()
               ...
               Autofarm:Toggle("Auto Collect Milestones", false, function(t)
            mile = t
