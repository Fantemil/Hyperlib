...
inj.MouseButton1Down:connect(function()
    wait(1)
    output.Text = "Sexy hamoot premium Injected!"
    wait(3)
    output.Text = " "
end)
...
title.Text = "Sexy hamoot (Premium)"
...
logo.Image = "http://www.roblox.com/asset/?id=15534426816"
...
mini.Image = "http://www.roblox.com/asset/?id=15534426816"
mini.Visible = false
