--THIS IS NOT MY SCRIPT I DON'T UPDATE THEM OR ANYTHING
--Credits: some where on google owner is lads
--Toggle Aimbot,ESP,FFA,...
--|| Aimbot Toggle : E
-- Team Based : P
-- ESP Loop : L
-- ESP Toggle : T           
-- Change aim part (Current ballistics) : [ is - ] is + ||
