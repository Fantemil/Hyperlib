...
local Window = Library.CreateLib("John's FE VR script Loader", "DarkTheme")
local Tab = Window:NewTab("Main")
local Section = Tab:NewSection("PLease use the steps")


Section:NewButton("Step 1", "ButtonInfo", function()
    spawn(function()
...
Section:NewButton("Step 2 (use the Simulationradius cmd)", "ButtonInfo", function()
...
Section:NewButton("Step 3", "ButtonInfo", function()
...
Section:NewButton("NET Bypass", "ButtonInfo", function()
