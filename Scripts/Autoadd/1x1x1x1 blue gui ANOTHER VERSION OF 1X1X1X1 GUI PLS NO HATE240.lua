...
e1x1x1x1Message.MouseButton1Down:connect(function()
	while true do
		...
		msg.Text = "1x1x1x1: GET HACKED BY 1X1X1X1 "
		wait(6)
		msg:remove()
		wait(3)
		...
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "1x1x1x1: I WILL DESTROY YOU ALL! YOU ARE WEAKLINGS"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		...
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "1x1x1x1: I WILL KILL YOU ALL!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
...
e2006Theme.MouseButton1Down:connect(function()
	...
	s.Name = "Sound"
	s.SoundId = "http://www.roblox.com/asset/?id=6923867528"
	s.Volume = 999
	s.Pitch = 1
	s.Looped = true
	s.archivable = false
