...
Title_2.Text = "(Made by k00p and bossjklo)"
Title_2.TextColor3 = Color3.fromRGB(295, 275, 230)
...
Title_3.BackgroundColor3 = Color3.fromRGB(11, 11, 11)
Title_3.BorderColor3 = Color3.fromRGB(54, 0, 0)
Title_3.BorderSizePixel = 0
Title_3.Position = UDim2.new(0.0976891741, 0, 11.3485, 0)
Title_3.Size = UDim2.new(0, 257, 0, 17)
Title_3.Font = Enum.Font.SourceSans
Title_3.Text = "Extra"
Title_3.TextColor3 = Color3.fromRGB(255, 180, 0)
...
Decalspam1.Text = "P00ng Decalspam"
...
_666.Name = "666"
_666.Parent = Title
_666.BackgroundColor3 = Color3.fromRGB(0, 12, 0)
_666.BorderColor3 = Color3.fromRGB(0, 53, 9)
...
Particles.Text = "p00ngkid-Particles"
...
jumpscare.Text = "g00by-Jumpscare"
...
s.Name = "Name" 
s.SoundId = "rbxassetid://6070263388" 
s.Pitch = 0.75
s.Volume = 2.58
s.Looped = true 
s.archivable = false 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		function xds(dd)
			for i,v in next,dd:children''do
				...
				local dec = 'http://www.roblox.com/asset/?id=12725691281';
...
local function NIMQSV_fake_script() -- Particles.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		for i, v in pairs(game.Players:GetChildren()) do
            ...
            pe.Texture = "http://www.roblox.com/asset/?id=12725691281"
            pe.VelocitySpread = 100000000000
            se = Instance.new("ParticleEmitter",v.Character.Torso)
            se.Texture = "http://www.roblox.com/asset/?id=12725691281"
            se.VelocitySpread = 100000000000
            fe = Instance.new("ParticleEmitter",v.Character.Torso)
            fe.Texture = "http://www.roblox.com/asset/?id=12725691281"
            fe.VelocitySpread = 100000000000
            ke = Instance.new("ParticleEmitter",v.Character.Torso)
            ke.Texture = "http://www.roblox.com/asset/?id=12725691281"
            ke.VelocitySpread = 100000000000
            end
		end)
end
...
local function GANYBB_fake_script() -- stopmusic.Script 
	...
	function onClick()
		Instance.new("Sound").Parent = game.Workspace  game.Workspace.Sound.SoundId ="rbxassetid://cáº·c!" game.Workspace.Sound.Looped=true  game.Workspace.Sound:Play()
	end
		...
		for i,v in pairs(game.Players:GetPlayers()) do
			if v.Name ~= me and not v.PlayerGui:FindFirstChild("Screamer") and v:FindFirstChild("PlayerGui") then
				spawn(function()
					...
					newgui.Name = "Screamer"
					local newimage = Instance.new("ImageLabel",newgui)
					newimage.Image = "http://www.roblox.com/asset/?id=12725691281"
					newimage.Size = UDim2.new(1,1,1,1)
					local s = Instance.new("Sound",newgui)
					s.SoundId = "rbxassetid://LOL"
					s.Volume = 9999999999999999999999999999999999999
					s.Looped = true
					s:Play()
					print("Screamed "..v.Name)
