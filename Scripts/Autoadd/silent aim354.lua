getgenv().Prediction =  (  .153  )   -- [ PREDICTION: Lower Prediction: Lower Ping | Higher Prediction: Higher Ping  ]
 
getgenv().FOV =  (  320  )   -- [ FOV RADIUS: Increases Or Decreases FOV Radius ]
...
--Farewell Atman, Nosss, Toru, Sewskii.