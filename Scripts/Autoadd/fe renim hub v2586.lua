...
Tabs.Main:AddButton({
    ...
    Tabs.Main:AddButton({
        Title = "fe creepy crawler",
        Description = "become creepy creatures made by myworld",
        Callback = function()
    ...
    Tabs.Main:AddButton({
        Title = "fe floppa",
        Description = "become floppa pet creatures made by myworld",
        Callback = function()
                            loadstring(game:HttpGet('https://pastebin.com/raw/07xmeJUG'))()
        end
    })
