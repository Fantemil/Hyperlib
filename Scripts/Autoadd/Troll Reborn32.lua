...
for i, buttonName in ipairs(buttons) do
    ...
    elseif buttonName == "New Player Fright" then
        button.MouseButton1Click:Connect(function()
            ...
            jumpscareImage.Image = "rbxassetid://6862780932" -- Jumpscare image asset ID
    ...
    elseif buttonName == "New Player Particles" then
        button.MouseButton1Click:Connect(function()
            ...
            particleEmitter.Texture = "rbxassetid://6862780932" -- Particle texture asset ID
