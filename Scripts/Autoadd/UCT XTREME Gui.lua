...
title.Text = ("Undertale Cringe Timeline XTREME GUI")
title.Font = ("Arcade")
...
Speed_Finish.BorderColor3 = Color3.fromRGB(85, 255, 250)
Speed_Finish.Text = ("Autofarm G")
Speed_Finish.TextColor3 = Color3.fromRGB(225, 255, 0)
...
BSpeed_Finish.Text = ("Tp to admin/testing area")
...
CSpeed_Finish.Text = ("Btools to delete doors cuz game has Garbage anticheat")
...
Game.Players.LocalPlayer.Character.HumanoidRootPart. CFrame = CFrame.new(22.7881546, 0.267894268, -1193.44287, 1, 0, 0, 0, 1, 0, 0, 0, 1)
...
game.Players.LocalPlayer.Character.HumanoidRootPart. CFrame = CFrame.new(131.036194, 0.470068604, -1151.32861, 0.999015689, -0.000101621023, 0.0443585627, 7.09804954e-05, 0.999999762, 0.000692321104, -0.0443586223, -0.00068849104, 0.99901545)
end)
