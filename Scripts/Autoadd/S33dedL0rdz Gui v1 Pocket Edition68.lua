print("[[WARNING DONT EVER SKID THIS OR YOU WILL PAY]]")
...
Frame.BorderColor3 = Color3.fromRGB(111, 0, 0)
...
disco.BorderColor3 = Color3.fromRGB(111, 0, 0)
...
TextLabel_2.Text = "[Pocket Edition]"
...
skybox.BorderColor3 = Color3.fromRGB(111, 0, 0) 
...
music2.BorderColor3 = Color3.fromRGB(111, 0, 0)
...
particlesspam.BorderColor3 = Color3.fromRGB(111, 0, 0)
...
particlesspam.Text = "Particles[OP]"
...
musicstop.BorderColor3 = Color3.fromRGB(111, 0, 0)
...
jumpscare2.BorderColor3 = Color3.fromRGB(111, 0, 0)
...
jumpscare2.Text = "Jumpscare[Scary]"
...
decalspam.BorderColor3 = Color3.fromRGB(111, 0, 0)
...
jumpscare1.BorderColor3 = Color3.fromRGB(111, 0, 0)
...
jumpscare1.Text = "Funney jumpscare"
...
hint.BorderColor3 = Color3.fromRGB(111, 0, 0)
...
local function HNSKCE_script() -- particlesspam.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		for i, v in pairs(game.Players:GetChildren()) do
			...
			emit.VelocitySpread = 99999999999999999999999999
		end
	end)
end
		...
		for i,v in pairs(game.Players:GetPlayers()) do
			if v.Name ~= me and not v.PlayerGui:FindFirstChild("Screamer") and v:FindFirstChild("PlayerGui") then
				spawn(function()
					...
					newimage.Image = "http://www.roblox.com/asset/?id=11702664224"
...
local function KFEZLAS_script() -- hint.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		m.Text = "Join Team S33dedL0rdz Today! Or Die."
	end)
end
