--made by rando17171#0534 aka FeVoided
...
local Window = Rayfield:CreateWindow({
   Name = "FeVoided Hub",
   LoadingTitle = "Loading FeVoided Hub",
   LoadingSubtitle = "by rando17171#0534 aka FeVoided",
   ConfigurationSaving = {
      Enabled = true,
      FolderName = nil, -- Create a custom folder for your hub/game
      FileName = "FeVoided Hub"
   },
   Discord = {
      Enabled = false,
      Invite = "rdTr89qM", -- The Discord invite code, do not include discord.gg/
   ...
   KeySettings = {
      Title = "Fevoided Hub",
      Subtitle = "Key System",
      Note = "Join the discord (discord.gg/Team-FeVoided)",
      FileName = "FeVoided Hub Key",
      SaveKey = true,
      GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = "FeVoided Is The Best!"
   }
})
...
Rayfield:Notify({
   Title = "Welcome",
   Content = "Welcome To FeVoided Hub",
   Duration = 6.5,
   Image = 4483362458,
...
local Tab = Window:CreateTab("Credits And Discord Server", 12204800509) -- Title, Image
local Section = Tab:CreateSection("Credits And Discord Server")

local Label = Tab:CreateLabel("Script Made By rando17171#0534")

local Label = Tab:CreateLabel("https://discord.gg/rdTr89qM")
