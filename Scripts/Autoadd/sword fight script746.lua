-- BRAIN POWER!
--edited by dux (scriptblox user = duxx, discord is dux#5908) 
--powering slavery ig
local active = true
...
TextLabel.Text = "Reach lmao (suggested by dux is 20 / 25) :"
...
TextLabel_2.Text = "Shape (use line if ur hardcore):"
...
TextButton.Text = "(killscript) bro why would you use this, it turns off the script like bro, i just be stroking my dick i got lotion on my dick right now and i just be strokin it (R to close GUI)"
