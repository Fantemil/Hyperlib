...
local Window = Library.CreateLib("Break Hub", "DarkTheme")

-- MAIN
local Tab = Window:NewTab("main")
local Section = Tab:NewSection("Aimbot")
Section:NewButton("Aimbot", "Kill all, Aimbot", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/tkorra/bp-gui/main/main.lua'))()
end)



Section:NewButton("Buster Gui", "Gui made bui Squid", function()
...
Section:NewButton("H4R7NHacks", "This is another hack gui", function()
...
Section:NewButton("V.G Hub", "Its a hub of cheats", function()
...
Section:NewButton("ESP", "Makes you see everyone with help", function()
...
Section:NewLabel("freefirepro232323")
Section:NewLabel("Fire")
Section:NewLabel("Squid")
Section:NewLabel("H4R7NHacks")