...
RecolorTextAndRename("Killer",Color3.new(0.25,0,0),Color3.new(1,0,0),"Antique")
MAINRUINCOLOR = BrickColor.new("Really red")
RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,false)
end
...
rainbowmode = false
chaosmode = true
RecolorTextAndRename("Ender",Color3.new(0,0,0),Color3.new(1,1,1),"Antique")
...
rainbowmode = false
chaosmode = false
RecolorTextAndRename("Blox Watch Hacker/John Doe",Color3.new(0,1,0),Color3.new(0.8,1,0.5),"Bodoni")
...
RecolorTextAndRename("Neptunian V",BrickColor.new("Royal purple").Color,BrickColor.new("Bright blue").Color,"SciFi")
...
rainbowmode = false
chaosmode = false
RecolorTextAndRename("ERROR 404 NOT FOUND",BrickColor.new("Really black").Color,BrickColor.new("Dark blue").Color,"Code")
...
rainbowmode = false
chaosmode = false
RecolorTextAndRename("Skyrocket",BrickColor.new("White").Color,BrickColor.new("Bright yellow").Color,"Code")
