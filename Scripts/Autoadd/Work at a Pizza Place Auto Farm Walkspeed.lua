...
local Window = Library.CreateLib("Pizza Hub", "DarkTheme")
...
--Scripts--
local Scripts = Window:NewTab("Script's")
local ScriptsSection = Scripts:NewSection("Scripts")


--admin--
ScriptsSection:NewButton("Infinitie Yield", "this is a admin script", function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
    print("Clicked")
end)


     ScriptsSection:NewButton("Pizza place gui", "Turk0yun Scripts", function()
     ...
     ScriptsSection:NewButton("new Auto Farm", "its working and fast!", function()
...
local settings = {refill_at=50, refill_end=97, deliver_at=10, stay_in_kitchen=true}
