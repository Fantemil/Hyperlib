...
title.Text = ("UT SAUMB XTreme Gui")
title.Font = ("Arcade")
...
Speed_Finish.Text = ("AutoFarm EXP")
...
BSpeed_Finish.BorderColor3 = Color3.fromRGB(255, 0, 88)
BSpeed_Finish.Text = ("Unlock All Characters")
BSpeed_Finish.TextColor3 = Color3.fromRGB(255, 88, 0)
...
CSpeed_Finish.BorderColor3 = Color3.fromRGB(98, 98, 0)
CSpeed_Finish.Text =("Get Badges")
CSpeed_Finish.TextColor3 = Color3.fromRGB(67, 88, 78)
...
GGGSpeed_Finish.Text = ("Kill all Bosses/Charas/Enemies")
...
game.Workspace.Map.Model.Name = ("FARMA")

while true do

for i,v in pairs(game.Workspace.Map.FARMA:GetChildren()) do
if v.Name == "Souls" then
v.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
  end
end
for i,v in pairs(game.Workspace.Map.Model:GetChildren()) do
if v.Name == "Souls" then
v.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
  end
end
...
game.Workspace.scythe.Position = game.Players.LocalPlayer.Character.Torso.Position
game.Workspace["F4T#L Err@r B0n3"].Position =  Game.Players.LocalPlayer.Character.Torso.Position
game.Workspace["Handle"].Position =  Game.Players.LocalPlayer.Character.Torso.Position
game.Workspace.Map["Old book"].Position = Game.Players.LocalPlayer.Character.Torso.Position
game.Workspace.Folder.Name = ("Er")
game.Workspace.Folder.CrossBlade.Position = game.Players.LocalPlayer.Character.Torso.Position
game.Workspace.Folder.Head.Position = game.Players.LocalPlayer.Character.Torso.Position
game.Workspace.Folder["Sans Bone"].Position = game.Players.LocalPlayer.Character.Torso.Position
game.Workspace.Folder["Souls"].Position = game.Players.LocalPlayer.Character.Torso.Position
game.Workspace.Folder["Top Hat"].Position = game.Players.LocalPlayer.Character.Torso.Position
game.Workspace.Folder["Apple"].Part.Position = game.Players.LocalPlayer.Character.Torso.Position
...
for I = 1, 5 do
game.Workspace.Folder["Union"].Position = game.Players.LocalPlayer.Character.Torso.Position
game.Workspace.Folder["Union"].Name = ("B")
end
game.Workspace.Er.Name = ("Folder")
...
for i,v in pairs (game.Workspace.Morph:GetChildren()) do
...
for i,d in pairs (b:GetChildren()) do

if d.Name == ("BadgeDoor") then
d:Remove()
end
end
end
