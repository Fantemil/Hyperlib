--[[
remake by Rxsky21 and AverageScripterYuh Dont forget to sub :D

]]

--[[---------Settings---------]]--
local bodyTransparency = 0.9 --Change the transparency of your character (0 - 1)
...
-----------------------------------------------------------
game.Workspace.VirtualBody.Head.Face:Destroy()
wait(9e9)