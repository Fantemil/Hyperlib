...
local Window = Library.CreateLib("Skibi Toilet Game (Episode 55) v3.4 fix by Artem89ru_2023", "RJTheme4")
...
game:GetService("Workspace").AllMorphs2.Station.AllMorphs2.TitanCameraMan.MorphPad.CFrame = CFrame.new(-318.04, 5286.97, -245.98)
end)

Section:NewButton("Mega Tank", "tp", function()
game:GetService("Workspace").AllMorphs2.Station.AllMorphs2.BigTank.MorphPad.CFrame = CFrame.new(-396.65, 5286.94, -224.63)
end)
...
Section:NewButton("G-Man Toilet (To choose from)", "tp to morph GManToilet", function()
local Character = game.Players.LocalPlayer.Character or game.Players.LocalPlayer.CharacterAdded:Wait()
if Character then
...
Section:NewButton("Glith Toilet", "tp to morph GlithToilet", function()
local Character = game.Players.LocalPlayer.Character or game.Players.LocalPlayer.CharacterAdded:Wait()
if Character then
...
Section:NewButton("Rocket Toilet", "tp to morph RocketToilet", function()
local Character = game.Players.LocalPlayer.Character or game.Players.LocalPlayer.CharacterAdded:Wait()
if Character then
...
local Tab = Window:NewTab("Admin Morphs")
...
Section:NewButton("Monster Skibi Toilet", "tp to morph", function()
local Character = game.Players.LocalPlayer.Character or game.Players.LocalPlayer.CharacterAdded:Wait()
if Character then
...
local Tab = Window:NewTab("GamepassTitans")
local Section = Tab:NewSection("Morphs")

Section:NewButton("Speaker Man Titan", "tp morph button", function()
game:GetService("Workspace").AllMorphs.Station.SkibiMorphs.TitanSpeakerMan.MorphPad.CFrame = CFrame.new(-686.43, 5286.97, 205.94)
end)

Section:NewButton("Camera Man Titan", "tp morph button", function()
game:GetService("Workspace").AllMorphs.Station.SkibiMorphs.TitanCameraMan.MorphPad.CFrame = CFrame.new(-695.22, 5286.97, -67.70)
end)

Section:NewButton("Tv Man Titan", "tp morph button", function()
game:GetService("Workspace").AllMorphs.Station.SkibiMorphs.TitanTvMan.MorphPad.CFrame = CFrame.new(-691.34, 5286.96, -404.72)
end)

Section:NewButton("Cinema Man Titan", "tp morph button", function()
game:GetService("Workspace").AllMorphs.Station.SkibiMorphs.UpgradedTitanTvMan.MorphPad.CFrame = CFrame.new(-689.86, 5286.95, -767.03)
end)

Section:NewButton("Upgraded Camera Man Titan", "tp morph button", function()
game:GetService("Workspace").AllMorphs.Station.SkibiMorphs.UpgradedTitanCameraMan.MorphPad.CFrame = CFrame.new(-689.62, 5286.97, -1128.20)
end)

local Tab = Window:NewTab("53, 55 EP. Toilet (New)")
local Section = Tab:NewSection("Morphs")

Section:NewButton("Ufo Toilet", "tp", function()
local Character = game.Players.LocalPlayer.Character or game.Players.LocalPlayer.CharacterAdded:Wait()
if Character then
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(420.62, 5697.19, -844.04)
end
end)

Section:NewButton("Giant Skull Toilet", "tp", function()
local Character = game.Players.LocalPlayer.Character or game.Players.LocalPlayer.CharacterAdded:Wait()
if Character then
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(538.22, 5697.16, -872.71)
end
end)

Section:NewButton("Flying Bath Tub Toilet", "tp", function()
local Character = game.Players.LocalPlayer.Character or game.Players.LocalPlayer.CharacterAdded:Wait()
if Character then
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(741.51, 5697.18, -870.42)
end
end)