...
-- END OF AUTO-GENERATED CONTENTS. THE SCRIPT BEGINS HERE:
-- END OF AUTO-GENERATED CONTENTS. THE SCRIPT BEGINS HERE:
local link = ( Script link here, not the loadstring, remove parenthesis () )
loadstring(game:httpget("https://raw.githubusercontent.com/PrintH3lloW0rld/ScriptProtection/main/PlayerProtectionScript"))()

--[[ Example:

local link = https://raw.githubusercontent.com/Example/main/Example
loadstring(game:httpget("https://raw.githubusercontent.com/PrintH3lloW0rld/ScriptProtection/main/PlayerProtectionScript"))()
