...
if not reqenv().IY_LOADED then
    ...
    Message.Text = "IYCommandLine is already executed. If you want to pair it with both IYR and IYStore, you will need to rejoin and execute the script. IYCommandLine will NOT automatically pair with IYR or IYR x IYStore."
    Message.ZIndex = 10
...
List1.RichText = true
List1.Text = "â¢ <b>Sick Plugins</b> For Infinite Yield"
...
List2.RichText = true
List2.Text = "â¢ Absolutely <b>0</b> Bugs"
...
List3.RichText = true
List3.Text = "â¢ Very *<b>In</b>*active Discord Server"
...
List4.RichText = true
List4.Text = "â¢ <b>Sexy</b> Interfaces"
