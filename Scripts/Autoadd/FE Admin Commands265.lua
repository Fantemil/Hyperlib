...
local window = PabloLib:Create("Lixii's Script")
...
local tab2 = window:CreateTab("More Coming Soon!")

tab2:CreateButton("Fake Chat", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/game-hax/uca/main/release/uca.min.lua"))()
end)

tab2:CreateButton("Fly", function()
...
tab2:CreateButton("Fling People(KeySystem)", function()
