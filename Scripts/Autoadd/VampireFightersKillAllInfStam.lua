...
do -- Example UI
 local Window = library:AddWindow("Statue - Vampire Fighters", {
 ...
 do -- Element
  Tab:AddLabel("Statue Vampire Fighters")
  Tab:AddButton("Kill All", function()
   loadstring(game:HttpGet("https://pastebin.com/raw/3n8tXxdq", true))()
            
  end)
  
  Tab:AddButton("No Jump Cooldown", function()
   loadstring(game:HttpGet("https://pastebin.com/raw/aZvf8LCx", true))()
            
  end)
  
  Tab:AddButton("Infinite Stamina", function()
   loadstring(game:HttpGet("https://pastebin.com/raw/KmBgBQnm", true))()
            
  end)
  local Tab = Window:AddTab("Extra")
  ...
  Tab:AddButton("ESP", function()
   loadstring(game:HttpGet("https://pastebin.com/raw/HqJxMirK", true))()
  end)
