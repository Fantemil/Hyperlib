...
local main = library:Load({Name = "Vio.CC | Buyer Build", Theme = "Dark", SizeX = 440, SizeY = 467, ColorOverrides = {}})
...
local trump = main:Tab("Resolver")
local boris = main:Tab("Antilock")
local obama = main:Tab("Extra")

local section = aimbot:Section({Name = "Target", column = 1})
...
game:GetService("RunService").RenderStepped:Connect(
    function()
        ...
        getgenv().Prediction = 0.17343243234332
        end
        end
        end
        end
...
local toggle6 = section:Toggle({Name = "Auto Prediction", Flag = "", callback = function(arg)
   getgenv().autpred = arg
end})
...
local colorPicker = section:ColorPicker({name = "Tracer Color", Default = Color3.fromRGB(79, 11, 158),  Flag = "", Callback = function(color)
...
local colorPicker = section:ColorPicker({name = "Circle Color", Default = Color3.fromRGB(79, 11, 158),  Flag = "", Callback = function(color)
...
local section = aimbot:Section({Name = "Camlock", column = 2})
...
local button = section4:Button({Name = "Enable Fly", Callback = function()
 local plr = game.Players.LocalPlayer
    local mouse = plr:GetMouse()
...
local toggle7 = section3:Toggle({Name = "ShowEsp", Flag = "Enable", callback = function(arg)
   ESP.TeamMates = arg
end})
...
local colorPicker2 = section3:ColorPicker({name = "Color", Default = Color3.fromRGB(79, 11, 158),  Flag = "Color", Callback = function(color)
   ESP.Color = color
end})
...
local section5 = trump:Section({Name = "Resolver", column = 1})
...
local section5 = trump:Section({Name = "Underground Resolver", column = 2})
...
local slider = section5:Slider({Name = "Underground AA Vel", Min = - 70, Max = - 1, Default = - 35, Decimals = 10, Flag = "", Callback = function(slider)
   getgenv().val = slider
end})
...
local section5 = boris:Section({Name = "SlingShot AA", column = 1})
...
local section5 = boris:Section({Name = "Blatant Fling AA", column = 1})
...
local section5 = boris:Section({Name = "Spinnis", column = 2})
...
local toggle = section4:Toggle({Name = "Remove Bag", Flag = "Enable", callback = function(arg)
getgenv().antibag = arg
