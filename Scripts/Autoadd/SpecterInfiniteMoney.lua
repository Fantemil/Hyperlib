...
elseif game.PlaceId == 5921569465 then
   wait(5)
   repeat wait() until game:GetService("Workspace"):FindFirstChild("House") ~= nil
   repeat wait() until game:GetService("Workspace").House:FindFirstChild("EE") ~= nil
   repeat wait() until game:GetService("Workspace").House.EE:FindFirstChild("AlleyDoor") ~= nil
   repeat wait() until game:GetService("Workspace").House.EE.AlleyDoor:FindFirstChild("ProximityPrompt") ~= nil
   game:GetService("Workspace").House.EE.AlleyDoor.ProximityPrompt.Enabled = true
   wait(0.5)
   game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").House.EE.AlleyDoor.CFrame * CFrame.new(2,1,0)
   wait(0.5)
   local pos = CFrame.new(game:GetService("Workspace").Camera.CFrame.Position, game:GetService("Workspace").House.EE.AlleyDoor.CFrame.Position)
   ...
   wait(1)
   fireproximityprompt(game:GetService("Workspace").House.EE.AlleyDoor.ProximityPrompt,1)
end