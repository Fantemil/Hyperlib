...
local Tab = Window:NewTab("cool stuff!")
local Section = Tab:NewSection("cool stuff")

Section:NewSlider("speed", "yea yea", 500, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
...
Section:NewKeybind("ui Toggle", "Toggle the ui", Enum.KeyCode.F, function()
	Library:ToggleUI()
end)

local Tab = Window:NewTab("rejoin")
local Section = Tab:NewSection("rejoin the game")

local Tab = Window:NewTab("unused")
local Section = Tab:NewSection("unused unused")


local Tab = Window:NewTab("unused")
local Section = Tab:NewSection("unused unused")

Section:NewButton("Dunking Simulator", "[Unlimited boost]", function()
    while true do
   wait(0.1)
...
local Tab = Window:NewTab("Easy.gg games")
local Section = Tab:NewSection("script for Easy.gg games")

Section:NewButton("Rift Royale!", "Aimbot, wallhacks, speed and more!", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/NewMainScript.lua", true))()
end)

Section:NewButton("Vape v4", "don't vape it's bad", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/NewMainScript.lua", true))()
end)

Section:NewButton("Islands Script GUI", "you know", function()
    loadstring(game:HttpGet("http://void-scripts.com/Scripts/islands_new.lua"))()
end)
local Tab = Window:NewTab("credits")
local Section = Tab:NewSection("credits")

Section:NewLabel("Cavly dev: He made this script with no sleep Rip his eys")

local Tab = Window:NewTab("misc")
local Section = Tab:NewSection("toys")

Section:NewButton("Pet Posse Simulator", "Well enough normal script with which you can farm coins, functions: Auto Coins, Rebirth, Auto Open Egg", function()
    loadstring(game:HttpGet(('https://raw.githubusercontent.com/shadowTW/dsadasdas/main/petposse.lua')))()
end)

Section:NewButton("GET TO THE TOP", "[Finish, Inf money]", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/fe9z/rblxscripts/main/Get%20to%20the%20top.lua"))()
end)

local Tab = Window:NewTab("roblox admin scripts")
local Section = Tab:NewSection("roblox admins")

Section:NewButton("Fate's Admin script", "Admin v2?", function()
    ------Fate's Admin (brought to you by Hacks Home)--------
loadstring(game:HttpGet("https://raw.githubusercontent.com/fatesc/fates-admin/main/main.lua"))();

end)

Section:NewButton("Roblox Super Admin", ".", function()
...
Section:NewButton("Cinematic Freecam Script", "ButtonInfo", function()
    -----------------------------------------------------------------------
-- Freecam
...
Section:NewButton("FE invisible fling (Universal Script)", "Universal Script", function()
    spawn(function()
