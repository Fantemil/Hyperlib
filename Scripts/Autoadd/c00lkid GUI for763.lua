...
local function showJumpscareImage()
    ...
    imageLabel.Image = "rbxassetid://18878364138"
    ...
    if button:IsA("TextButton") then
        button.MouseButton1Click:Connect(function()
            ...
            elseif button.Name == "particle" then
                createParticles("rbxassetid://18878024834", 20)
            elseif button.Name == "particle1" then
                createParticles("rbxassetid://18878024834", 50)
            end
        end)
    end
end
