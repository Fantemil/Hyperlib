...
local animations = {
    idle = "rbxassetid://18538150608",    -- Primary idle animation
    idleAlt = "rbxassetid://18538150608", -- Alternate idle animation
...
-- Run the functions to replace animations, ensure they loop, and 
replaceAnimations()
