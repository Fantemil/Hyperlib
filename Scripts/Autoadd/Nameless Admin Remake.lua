...
cmd.add({"hitboxgui"}, {"hitboxgui", "opens hitbox gui"}, function()
...
cmd.add({"simplity"}, {"simplity", "Opens Simplity Fe Menu"}, function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/UnNamedRBScripts/Roblox-Simplity-Remake/main/Simplity%20UnNamed%20Remix.txt"))()
end)

cmd.add({"SwordFightBot"}, {"SFB", "Press X to sword fight (Works with any melee)"}, function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/UnNamedRBScripts/Sword-Fight-Bot/main/Sword%20Fight%20Bot.txt"))()
end)
...
local Human = game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChildOfClass('Humanoid')
	if not Human then
		...
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = 	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.Angles(math.pi * .5, 1000, 0)
	Human.Sit = true
	task.wait(0.01)
...
local Human = game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChildOfClass('Humanoid')
	...
	Human.Sit = true
	task.wait(.1)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = 	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.Angles(math.pi * .5, 0, 0)
...
game:GetService("RunService").Stepped:Connect(function()
    ...
    for _, part in pairs(game.Players:GetChildren()) do
        if part.Character and part ~= game.Players.LocalPlayer.Character then
            for _, item in pairs(part.Character:GetDescendants()) do
...
cmd.add({"cfly"}, {"cfly [speed]", "CFrame fly"}, function(...)
CFspeed = (...)
if CFspeed == nil then
    CFspeed = 50
    end
...
cmd.add({"uncfly"}, {"uncfly", "CFrame fly disabler"}, function()
if CFloop then
		CFloop:Disconnect()
...
cmd.add({"dance"}, {"dance", "Does a random dance"}, function()
   local dances = {"248263260", "27789359", "45834924", "28488254", "33796059", "30196114", "52155728"}
if theanim then
    theanim:Stop()
theanim:Destroy()
		local animation = Instance.new("Animation")
...
cmd.add({"chat", "message"}, {"chat <text> (message)", "Chats you, useful if youre muted"}, function(msg)
...
flinging = false
cmd.add({"Spinfling"}, {"sfling", "Spin Fling"}, function()
	flinging = false
...
cmd.add({"glue"}, {"glue <player>", "Bangs the player by attaching to them"}, function(...)
	...
	local players = getPlr(Username)
			bangAnim = Instance.new("Animation")
			if not r15(game.Players.LocalPlayer) then
				bangAnim.AnimationId = "rbxassetid://0"
			else
				bangAnim.AnimationId = "rbxassetid://0"
			end
			bang = game.Players.LocalPlayer.Character:FindFirstChildOfClass('Humanoid'):LoadAnimation(bangAnim)
...
repeat wait()
	...
	wait(0.1)
	until wsbypass == false
end)

cmd.add({"unwalkspeedbypass", "unwsbypass"}, {"unwalkspeedbypass (unwsbypass)", "Disables the walkspeed bypass command"}, function()
wsbypass = false
end)
...
TextClickButton.BackgroundTransparency = 1
TextClickButton.Position = UDim2.new(0.48909232, 0, 0, 0)
TextClickButton.Size = UDim2.new(0, 32, 0, 33)
...
for i=1, 86 do
wait(0.004)
TextClickButton.BackgroundTransparency -= 0.01
end
