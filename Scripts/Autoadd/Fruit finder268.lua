...
Valuable = {"Dough Fruit","Shadow Fruit","Venom Fruit","Control Fruit","Dragon Fruit","Spirit Fruit","Leopard Fruit," "kitsune Fruit"} ------ it will stop the script if you got this fruit
Webhook = "" --------------------------------Optional
