...
createFrame(true, Color3.fromRGB(84, 84, 84), 0, 0, false, "Top", screenGui, UDim2.new(0.289, 0, 0.162, 0), UDim2.new(0, 361, 0, 31))
screenGui.Top.Active = true
screenGui.Top.Draggable = true
...
createTextLabel(backColor, 1, 1, Enum.Font.SourceSansBold, "Name", screenGui.Top, UDim2.new(0.147, 0, 0, 0), UDim2.new(0, 109, 1, 0), "Rose Hub - BETA", textColor, 18, true, Enum.TextXAlignment.Left, Enum.TextYAlignment.Center, 1)
...
createTextButton(backColor, 0.75, 0, Enum.Font.SourceSansBold, "Discord", screenGui.Top.Important.HomeTab, UDim2.new(0.024, 0, 0.721, 0), UDim2.new(0, 200, 0, 50), "Discord Server", textColor, 14, 1, function()
...
local execInput = createTextBox(backColor, 1, 0, Enum.Font.SourceSans, "input", screenGui.Top.Important.ExecutorTab.Holder, "Input script here...", UDim2.new(0, 10, 0, 10), UDim2.new(0, 170, 1, 0), "", textColor, 14, true, Enum.TextXAlignment.Left, Enum.TextYAlignment.Top)
...
execInput.Changed:connect(function(property)
	...
	if property == "Text" then
		...
		--print(execInput.TextBounds.Y + execInput.TextSize, execInput.TextBounds.Y - execHolder.CanvasPosition.Y, execHolder.CanvasPosition.Y - 224)
		if movedExec == false and execInput.TextBounds.Y - execHolder.CanvasPosition.Y >= 201 then
			execHolder.CanvasPosition = Vector2.new(0, execInput.TextBounds.Y + 224 + execInput.TextSize + 10)
			movedExec = false
			--[[
		elseif movedExec == false and execInput.TextBounds.Y == 224 and execHolder.CanvasPosition.Y <= 0 then
			execHolder.CanvasPosition = Vector2.new(0, execInput.TextBounds.Y + 224)
			movedExec = true
			--]]
...
createTextButton(backColor, mainTrans, 0, Enum.Font.SourceSansBold, "Opacity ", screenGui.Top.Important.SettingsTab, UDim2.new(0, 108, 0, 10), UDim2.new(0, 93, 0, 31), "Opacity", textColor, 15, 3, function()
	
end)

createImageLabel(1, "rbxasset://textures/ui/TopBar/dropshadow.png", "TopBarShadow", screenGui.Top.Important.SettingsTab["Opacity "], UDim2.new(0, 0, 1, 0), false, UDim2.new(1, 0, 0, 3), 4)
...
createTextButton(backColor, mainTrans, 0, Enum.Font.SourceSansBold, "search", screenGui.Top.Important["Script SearchTab"], UDim2.new(0.73, 0, 0.043, 0), UDim2.new(0, 50, 0, 28), "Search", textColor, 15, 3, function()
	
end)

createImageLabel(1, "rbxasset://textures/ui/TopBar/dropshadow.png", "TopBarShadow", screenGui.Top.Important["Script SearchTab"].search, UDim2.new(0, 0, 1, 0), false, UDim2.new(1, 0, 0, 3), 4)

createTextBox(backColor, mainTrans, 0, Enum.Font.SourceSans, "scriptinput", screenGui.Top.Important["Script SearchTab"], "", UDim2.new(0, 0, 0.046, 0), UDim2.new(0, 148, 0, 27), "", Color3.fromRGB(27, 42, 53), 14, false, Enum.TextXAlignment.Center, Enum.TextYAlignment.Center)

createImageLabel(1, "rbxasset://textures/ui/TopBar/dropshadow.png", "TopBarShadow", screenGui.Top.Important["Script SearchTab"].scriptinput, UDim2.new(0, 0, 1, 0), false, UDim2.new(1, 0, 0, 3), 4)

createTextButton(backColor, mainTrans, 0, Enum.Font.SourceSansBold, "search", screenGui.Top.Important.AudiosTab, UDim2.new(0.73, 0, 0.043, 0), UDim2.new(0, 50, 0, 28), "Search", textColor, 15, 3, function()
...
createTextBox(backColor, mainTrans, 0, Enum.Font.SourceSans, "audioinput", screenGui.Top.Important.AudiosTab, "", UDim2.new(0, 0, 0.046, 0), UDim2.new(0, 148, 0, 27), "", Color3.fromRGB(27, 42, 53), 14, false, Enum.TextXAlignment.Center, Enum.TextYAlignment.Center)
...
createTextButton(backColor, mainTrans, 0, Enum.Font.SourceSansBold, "search", screenGui.Top.Important.DecalsTab, UDim2.new(0.73, 0, 0.043, 0), UDim2.new(0, 50, 0, 28), "Search", textColor, 15, 3, function()
...
createTextBox(backColor, mainTrans, 0, Enum.Font.SourceSans, "decalinput", screenGui.Top.Important.DecalsTab, "", UDim2.new(0, 0, 0.046, 0), UDim2.new(0, 148, 0, 27), "", Color3.fromRGB(27, 42, 53), 14, false, Enum.TextXAlignment.Center, Enum.TextYAlignment.Center)
...
createFrame(false, backColor, 0, 0, false, "Frame", screenGui.Top, UDim2.new(0.465, 0, 0.194, 0), UDim2.new(0, 1, 0, 21))

createFrame(false, backColor, 1, 0, true, "CurrentTab", screenGui.Top, UDim2.new(0.485, 0, -0.016, 0), UDim2.new(0, 109, 0, 31))
...
for i,v in pairs(coreGui:GetChildren()) do
	if v.Name == "RoseHub" and v ~= screenGui then
		v:Destroy()
	end
end
