...
local TravelSpeed = 11.3 -- going too fast might get you kicked
...
--[[
   ...
   Made by MrHello on Discord ( MrHello#1405 on discord )
   Last tested for V1.0.8a (Still Works) 
...
-- Ignore everything below here ( UNLESS U KNOW WHAT UR DOING!)
