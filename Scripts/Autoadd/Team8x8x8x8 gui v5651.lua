...
ImageLabel.Image = "rbxassetid://16116964034"
...
TextLabel.Text = "team8x8x8x8 gui v0.2"
...
for Get,Players in ipairs(game.Players:GetPlayers()) do
			...
			for Get,Workspace in ipairs(game.Workspace:GetChildren()) do
				...
				if (Workspace.Name == Players.Name) then
					...
					ParticleEmitter.Texture = ("rbxassetid://16116964034");
		...
		for Get,Workspace in ipairs(game.Workspace:GetChildren()) do
			...
			ParticleEmitter.Texture = ("rbxassetid://433517918");
...
for i,v in next,workspace:children''do
			if(v:IsA'BasePart')then
				...
				tlb.Text='888 888 888 444 the hell opens ahahaha i will cause tr0ub1e';
...
local tubers93		= Instance.new("Sound")
		...
		tubers93.SoundId		= "rbxassetid://1839246774"
...
for Get,Players in ipairs(game.Players:GetPlayers()) do
		...
		s.Pitch = 0.7 --You can edit these settings.
		...
		s.SoundId = "http://www.roblox.com/asset/?id=142376088" --Put the idi into there.
...
TextButton.MouseButton1Click:Connect(function()
		...
		while true do
			msg.Text = "This Game Get Fucked By Teamc00lkidd LeL"
			wait(1.5)
			msg.Text = "Get Fucked Mafaka1!1!!1!1"
			wait(1.5)
			msg.Text = "Team8x8x8x8 LeL1!1!!1!1"
			wait(1.5)
		end
end)
...
TextLabel.BorderColor3 = Color3.new(0, 0, 0)
TextLabel.BorderSizePixel = 0
TextLabel.Text = "Cerdits To : KingHax And Teamc078kidd"
...
TextLabel.BorderColor3 = Color3.new(0, 0, 0)
TextLabel.BorderSizePixel = 0
TextLabel.Text = "Made By teamc078kidd "
