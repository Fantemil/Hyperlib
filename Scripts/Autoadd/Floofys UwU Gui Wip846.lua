...
do -- Example UI
	local Window = library:AddWindow("Floofys Tranzit: Remastered UwU Gui", {
		main_color = Color3.fromRGB(0, 0, 110),
	...
	do 
		Tab:AddLabel("Made By: Floofy_Bubba#4008 | Elerium UI Library v2 Used")

		Tab:AddButton("Infinity Ammo On Current Gun", function()
local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Upbolt/Hydroxide/revision/ohaux.lua"))()
local scriptPath = game.Players.LocalPlayer.Character:FindFirstChildWhichIsA("Tool")["Gun Script"]
local closureName = "refill"
...
debug.setupvalue(closure, upvalueIndex, value)
		...
		Tab:AddTextBox("Money Amount", function(text)
local money = text
game:GetService("Lighting").ETC:FireServer({0, money, "Rewards\240\159\144\153"})
		end, {
			["clear"] = false,
		})
		
		Tab:AddKeybind("Infinity Ammo On Current Gun Keybind", function(key)
			local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Upbolt/Hydroxide/revision/ohaux.lua"))()
local scriptPath = game.Players.LocalPlayer.Character:FindFirstChildWhichIsA("Tool")["Gun Script"]
local closureName = "refill"
local upvalueIndex = 3
