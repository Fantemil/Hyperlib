getgenv().ToggleKey =  (  "q"  )  -- [ Toggle On And Off | Stop asking re-tarded questions ]
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/loi31/cracked/main/nosslock.lua", true))();