...
main.Name = "main"
main.Parent = window
main.BackgroundColor3 = Color3.fromRGB(236, 236, 236)
...
inj.MouseButton1Down:connect(function()
	wait(1)
	output.Text = "ShitSploit Injected!"
	wait(3)
	output.Text = " "
end)
...
logo.Image = "http://www.roblox.com/asset/?id=1212687121"
...
mini.Image = "http://www.roblox.com/asset/?id=1212687121"
mini.Visible = false
