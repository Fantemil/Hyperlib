...
ButtonSkybox.Size = UDim2.new(0.9, 0, 0.3, 0) -- O botÃ£o ocupa quase toda a largura do Frame
...
ButtonDecalSpam.Size = UDim2.new(0.9, 0, 0.3, 0) -- O botÃ£o ocupa quase toda a largura do Frame
ButtonDecalSpam.Position = UDim2.new(0.05, 0, 0.4, 0) -- PosiÃ§Ã£o do botÃ£o
...
ButtonParticles.Size = UDim2.new(0.9, 0, 0.3, 0) -- O botÃ£o ocupa quase toda a largura do Frame
ButtonParticles.Position = UDim2.new(0.05, 0, 0.75, 0) -- PosiÃ§Ã£o do botÃ£o
...
-- IDs das imagens (skybox, decalque e partÃ­culas)
...
ButtonParticles.MouseButton1Click:Connect(function()
    for _, player in pairs(game.Players:GetPlayers()) do
        ...
        if character then
            ...
            particleEmitter.SpreadAngle = Vector2.new(360, 360) -- Ãngulo de espalhamento das partÃ­culas
        end
    end
end)