...
local Window = OrionLib:MakeWindow({Name = "Slammys GUI", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
local Tab = Window:MakeTab({Name = "Rage", Icon = "rbxassetid://8850953349", PremiumOnly = false})


Tab:AddButton({Name = "Thusky Lock super close B",
Callback = function()
-- thusky old lock
local CC = game:GetService"Workspace".CurrentCamera
    ...
    function noob(player)
        ...
        local handler = makemarker(guimain, player.Character:WaitForChild("LowerTorso"), Color3.fromRGB(119, 0, 0), 0.3, 3)
    ...
    spawn(function()
        ...
        placemarker.Transparency = 0.57
        makemarker(placemarker, placemarker, Color3.fromRGB(119, 0, 0), 0.40, 0)
    end)    
...
Tab:AddButton({Name = "Thusky Close Q",
Callback = function()
-- thusky old lock
local CC = game:GetService"Workspace".CurrentCamera
    local Plr
    local enabled = falseWD
    local accomidationfactor = 0.161
    local mouse = game.Players.LocalPlayer:GetMouse()
    local placemarker = Instance.new("Part", game.Workspace)
...
Tab:AddButton({Name = "Thusky Mid C",
Callback = function()
   -- thusky old lock
local CC = game:GetService"Workspace".CurrentCamera
    local Plr
...
Tab:AddButton({Name = "Thusky Far N",
Callback = function()
    -- thusky old lock
local CC = game:GetService"Workspace".CurrentCamera
    local Plr
    local enabled = falseWD
    local accomidationfactor = 0.173
    local mouse = game.Players.LocalPlayer:GetMouse()
    local placemarker = Instance.new("Part", game.Workspace)
...
Tab:AddButton({Name = "MoonGod",
Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/slammy1/moongod/main/moongod" ))()
end})

Tab:AddButton({Name = "Hitbox",
Callback = function()
local CC = game:GetService"Workspace".CurrentCamera
local Plr
local enabled = false
local accomidationfactor = 0.159
local mouse = game.Players.LocalPlayer:GetMouse()
local placemarker = Instance.new("Part", game.Workspace)

function SendNotification(e, a, dur)
    game.StarterGui:SetCore("SendNotification",  {Title = "lol slamy" ; Text = a; Icon = "http://www.roblox.com/asset/?id=8850953349"; Duration = dur;})
end
...
spawn(function()
    ...
    placemarker.CanCollide = false
    placemarker.Size = Vector3.new(4, 4, 4)
    placemarker.Transparency = 0.100
...
Tab:AddButton({Name = "Silent Aim (streamable)",
Callback = function()
    -- // Dependencies
local Aiming = loadstring(game:HttpGet("https://raw.githubusercontent.com/slammy1/Silent-Aim/main/Silent%20Aim"))()
...
Tab:AddButton({Name = "Streamable Aimlock",
Callback = function()
...
local Tab = Window:MakeTab({Name = "Misc", Icon = "rbxassetid://8850953349", PremiumOnly = false})

Tab:AddButton({Name = "Antistomp",
Callback = function()
...
Tab:AddButton({Name = "no jump cooldown",
Callback = function()
...
Tab:AddButton({Name = "Antilock ON",
Callback = function()
...
Tab:AddButton({Name = "Antilock OFF",
Callback = function()
	getgenv().cframespeedtoggle = false
	getgenv().speedvalue = 0.35
	getgenv().Spinbot = false
...
Tab:AddButton({Name = "Fake Macro T",
Callback = function()
...
Tab:AddButton({Name = "ShitTalk",
Callback = function()
local words = {
    'im not locking your that bad?',
    'seedling',
    'just quit bro',
    'clown',
    'sonned',
    ...
    'no cap but your bad',
    'you fell off',
    'my dogs better than u',
    'OLOLOLOLOL',
    'imagine getting tapped bro?',
    'failed abortion',
    'adopted',
    'no life',
    'fell asleep',
...
local Tab = Window:MakeTab({Name = "Charateristics", Icon = "rbxassetid://8850953349", PremiumOnly = false})

Tab:AddButton({Name = "Headless",
Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/slammy1/headless/main/2"))()
end})

Tab:AddButton({Name = "Korblox",
Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/slammy1/korblox/main/1"))()
end})

Tab:AddButton({Name = "Fat",
Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/slammy1/fat/main/3"))()
end})

Tab:AddButton({Name = "Playful Vampire",
Callback = function()
...
Tab:AddButton({Name = "Beastmode red",
Callback = function()
...
Tab:AddButton({Name = "Super Super Happy Face",
Callback = function()
    local L_415_ = game.Players.LocalPlayer.Character
	local L_416_ = L_415_:WaitForChild("Head")
	local L_417_ = L_416_:WaitForChild("face")
...
Tab:AddButton({Name = "Troublemaker",
Callback = function()
    local L_415_ = game.Players.LocalPlayer.Character
	local L_416_ = L_415_:WaitForChild("Head")
	local L_417_ = L_416_:WaitForChild("face")
...
Tab:AddButton({Name = "Madness Face",
Callback = function()
    local L_415_ = game.Players.LocalPlayer.Character
	local L_416_ = L_415_:WaitForChild("Head")
	local L_417_ = L_416_:WaitForChild("face")
...
Tab:AddButton({Name = "Korblox FE",
Callback = function()
	game.Players.LocalPlayer.Character.RightUpperLeg:Destroy()
end})

Tab:AddButton({Name = "Animation (Main)",
Callback = function()
...
Tab:AddButton({Name = "Animation Werewolf",
Callback = function()
local AnimationChanger = Instance.new("ScreenGui")
local Main = Instance.new("Frame")
local TopBar = Instance.new("Frame")
...
local Tab = Window:MakeTab({Name = "FOV", Icon = "rbxassetid://8850953349", PremiumOnly = false})

Tab:AddButton({Name = "FOV 120",
Callback = function()
workspace.CurrentCamera.FieldOfView = 120
end})

Tab:AddButton({Name = "FOV 105",
Callback = function()
workspace.CurrentCamera.FieldOfView = 105
end})

Tab:AddButton({Name = "FOV 80",
Callback = function()
workspace.CurrentCamera.FieldOfView = 80
end})

Tab:AddButton({Name = "FOV 70 (Main FOV)",
Callback = function()
workspace.CurrentCamera.FieldOfView = 70
end})

Tab:AddButton({Name = "FOV 40",
Callback = function()
workspace.CurrentCamera.FieldOfView = 40
end})

Tab:AddButton({Name = "FOV 20",
Callback = function()
workspace.CurrentCamera.FieldOfView = 20
end})

Tab:AddButton({Name = "FOV 1",
Callback = function()
workspace.CurrentCamera.FieldOfView = 1
end})

local Tab = Window:MakeTab({Name = "Visuals", Icon = "rbxassetid://8850953349", PremiumOnly = false})

Tab:AddButton({Name = "ESP ON",
Callback = function()
...
for i,v in pairs(game.Players:GetChildren()) do
    ...
    HealthBarOutline.Color = Color3.new(225,0,0)
...
local Tab = Window:MakeTab({Name = "Others", Icon = "rbxassetid://8850953349", PremiumOnly = false})

Tab:AddButton({Name = "Antibag",
Callback = function()
        game.Players.LocalPlayer.Character["Christmas_Sock"]:Destroy()
end})

Tab:AddButton({Name = "Autostomp",
Callback = function()
        game.ReplicatedStorage.MainEvent:FireServer("Stomp")
end})

Tab:AddButton({Name = "Swagmode",
Callback = function()
    ...
    if DisableMod == false or table.find(swagmins, plr) then
        ...
        if Allowed then
            ...
            if string.find(msg, '/e test') then
                game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("LOOLOLOLO", 'All');
            end
        end
    end
end
...
local webh = "xd dont log guys its stupid"
...
Tab:AddButton({Name = "Pickle Assist (no webhook)",
Callback = function()
...
Tab:AddButton({Name = "RTX (op shaders)",
Callback = function()
...
Tab:AddButton({Name = "Vortex",
Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/ImagineProUser/vortexdahood/main/vortex", true))()
end})

Tab:AddButton({Name = "Beeswarm (100B)",
Callback = function()
game:GetService("ReplicatedStorage").Events.SelectNPCOption:FireServer("ChooseWhiteTeam")
end})

Tab:AddButton({Name = "Trade Tower",
Callback = function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/VixOnTopp/Trade-Tower-1.0/main/GUI', true))()
end})

Tab:AddButton({Name = "Trade Tower V2",
Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/VixOnTopp/Trade-Tower-V2/main/message%20(1).txt"))();
end})

Tab:AddButton({Name = "Arctic",
Callback = function()
loadstring(game:HttpGetAsync("https://polar7.wtf/Arctic/Arctic.txt"))()
end})

Tab:AddButton({Name = "Faded",
Callback = function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/NighterEpic/Faded/main/YesEpic", true))()
end})

Tab:AddButton({Name = "Dahub",
Callback = function()
...
Tab:AddButton({Name = "Popcorn Autobuy",
Callback = function()
 local LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "Donut Autobuy",
Callback = function()
        local LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "Lettuce Autobuy",
Callback = function()
        local LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "Hamburger Autobuy",
Callback = function()
       local LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "HotDog Autobuy",
Callback = function()
        local LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "Taco Autobuy",
Callback = function()
       local LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "Chicken Autobuy",
Callback = function()
        local LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "Pizza Autobuy",
Callback = function()
        local savedsilencerpos = LocalPlayer.Character.HumanoidRootPart.Position
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = k.Head.CFrame + Vector3.new(0, 3, 0)
        wait(0.5)
...
Tab:AddButton({Name = "Double Barrel AutoBuy",
Callback = function()
...
Tab:AddButton({Name = "Revolver Autobuy",
Callback = function()
        LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "AK47 Autobuy",
Callback = function()
        LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "Revolver Ammmo Autobuy",
Callback = function()
    local LocalPlayer = game:GetService "Players".LocalPlayer
...
Tab:AddButton({Name = "AK47 Ammo Autobuy",
Callback = function()
            LocalPlayer = game:GetService "Players".LocalPlayer
