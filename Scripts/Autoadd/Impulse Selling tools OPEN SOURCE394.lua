...
------------------------------------------------------------------
------------------------------------------------------------------
local Window = OrionLib:MakeWindow({Name = "Impulse | Selling Tools | Da Hood", HidePremium = true, SaveConfig = true, ConfigFolder = "ImpulseConfig", IntroText = "Impulse"})
------------------------------------------------------------------
------------------------------------------------------------------
------------------------------------------------------------------
------------------------------------------------------------------
...
--
Tab3:AddLabel("Fake Animations Coming soon..")
----------------------------------
Tab4:AddLabel("Scripter: flood#7823")
--
Tab4:AddLabel("Made In One Day")
--
Tab4:AddButton({
	Name = "Kick Yourself",
	Callback = function()
game.Players.LocalPlayer:Kick("Impulse Selling Tools")
  	end    
})