--original script by Kidd_Anonymouse#9926

--edited by Hmm465#7106

--this edit automatically makes you r6 again if you die
...
wait(.1)
workspace.CurrentCamera.CameraSubject = Figure.Humanoid
workspace.CurrentCamera.CameraType = "Custom"
Figure.CameraMinZoomDistance = 0.5
Figure.CameraMaxZoomDistance = 400
end
end
oof()