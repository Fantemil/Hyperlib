...
Converted["_Frame"].Position = UDim2.new(0.356356978, 0, 0.311274499, 0)
Converted["_Frame"].Size = UDim2.new(0, 193, 0, 398)
...
Converted["_TextButton"].Position = UDim2.new(0, 0, 1.66666663, 0)
Converted["_TextButton"].Size = UDim2.new(0, 94, 0, 50)
...
local function DVBYLRS_fake_script() -- Fake Script: StarterGui.ScreenGui.Frame.Frame.TextButton.LocalScript
...
local function UPQJD_fake_script() -- Fake Script: StarterGui.ScreenGui.Frame.Smooth GUI Dragging
    local script = Instance.new("LocalScript")
...
coroutine.wrap(DVBYLRS_fake_script)()
coroutine.wrap(UPQJD_fake_script)()