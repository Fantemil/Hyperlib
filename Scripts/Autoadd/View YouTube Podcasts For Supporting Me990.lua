...
title.Text = "View YouTube Podcasts"
...
GetKeyButton.Text = "Support Me"
GetKeyButton.Parent = frame
--------------------------------------------------------------------------
SubmitButton.MouseButton1Click:Connect(function()
    local KeySystem = KeySystem.Text
    if KeySystem == "ok" then   
screenGui:Destroy()

--
loadstring(game:HttpGet("Ban",true))()
  
  end
end)

GetKeyButton.MouseButton1Click:Connect(function()
 setclipboard("https://gateway.platoboost.com/l/43666/6ae965fe") 
end) 