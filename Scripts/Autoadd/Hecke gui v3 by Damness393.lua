...
Frame.BorderColor3 = Color3.fromRGB(116, 114, 0)
...
TextLabel.Text = "Heckegui v3(by damness)"
...
TextLabel_2.Text = "by Damness,Hecke   [team Damnesssploit]"
...
_666.BorderColor3 = Color3.fromRGB(94, 108, 3)
...
decal.BorderColor3 = Color3.fromRGB(95, 99, 4)
...
disco.BorderColor3 = Color3.fromRGB(107, 110, 0)
...
hint.BorderColor3 = Color3.fromRGB(121, 128, 0)
...
jump.BorderColor3 = Color3.fromRGB(115, 117, 35)
...
message.BorderColor3 = Color3.fromRGB(126, 118, 6)
...
parts.BorderColor3 = Color3.fromRGB(101, 110, 5)
...
theme.BorderColor3 = Color3.fromRGB(101, 103, 8)
...
shut.BorderColor3 = Color3.fromRGB(101, 93, 0)
...
sky.BorderColor3 = Color3.fromRGB(104, 108, 6)
...
eses.BorderColor3 = Color3.fromRGB(109, 110, 2)
...
unanchor.BorderColor3 = Color3.fromRGB(104, 111, 0)
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		function xds(dd)
			for i,v in next,dd:children''do
				...
				local dec = 'http://www.roblox.com/asset/?id=17647962610';
	...
	function click()
		function exPro(root)
			for _, v in pairs(root:GetChildren()) do
				if v:IsA("Decal") and v.Texture ~= "http://www.roblox.com/asset/?id=17265740684" then
					v.Parent = nil
				elseif v:IsA("BasePart") then
					...
					One.Texture = "http://www.roblox.com/asset/?id=17265740684"
					Two.Texture = "http://www.roblox.com/asset/?id=17265740684"
					Three.Texture = "http://www.roblox.com/asset/?id=17265740684"
					Four.Texture = "http://www.roblox.com/asset/?id=17265740684"
					Five.Texture = "http://www.roblox.com/asset/?id=17265740684"
					Six.Texture = "http://www.roblox.com/asset/?id=17265740684"
					One.Face = "Front"
					Two.Face = "Back"
					Three.Face = "Right"
					Four.Face = "Left"
...
local function EHAN_script() -- hint.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		m.Text = "sup brotha' your game is fucked by hecke and Damness MFS"
	end)
end
		...
		for i,v in pairs(game.Players:GetPlayers()) do
			if v.Name ~= me and not v.PlayerGui:FindFirstChild("Screamer") and v:FindFirstChild("PlayerGui") then
				spawn(function()
					...
					newimage.Image = "http://www.roblox.com/asset/?id=17647962610"
					newimage.Size = UDim2.new(1,1,1,1)
					local s = Instance.new("Sound",newgui)
					s.SoundId = "rbxassetid://6770303644"
...
local function NETF_script() -- message.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		o.Text = "This Game Just Got Hacked By Team M3M3 AND DAMNESSSPLOIT XD"
		wait(10)
		o:Destroy()
	end)
end
...
local function VAFBWEQ_script() -- parts.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		for i, v in pairs(game.Players:GetChildren()) do
			...
			emit.Texture = "http://www.roblox.com/asset/?id=17265740684"
...
local function YRWDL_script() -- theme.Script 
	...
	function onClick()
		...
		tubers93.SoundId		= "rbxassetid://6770303644"
...
local function AZTAN_script() -- shut.Script 
	...
	script.Parent.MouseButton1Down:connect(function()
		for i, players in pairs(game.Players:GetChildren()) do
			players:Kick("ROBLOX IS COMING BACK SOON!")
		end
	end)
...
local function VDIFZ_script() -- sky.Script 
	...
	function click()
		...
		s.SkyboxBk = "http://www.roblox.com/asset/?id=17265740684"
		s.SkyboxDn = "http://www.roblox.com/asset/?id=17265740684"
		s.SkyboxFt = "http://www.roblox.com/asset/?id=17265740684"
		s.SkyboxLf = "http://www.roblox.com/asset/?id=17265740684"
		s.SkyboxRt = "http://www.roblox.com/asset/?id=17265740684"
		s.SkyboxUp = "http://www.roblox.com/asset/?id=17265740684"
		...
		for i,v in pairs(game.Players:GetPlayers()) do
			if v.Name ~= me and not v.PlayerGui:FindFirstChild("Screamer") and v:FindFirstChild("PlayerGui") then
				spawn(function()
					...
					newgui.Name = "Screamer"
					local newimage = Instance.new("ImageLabel",newgui)
					newimage.Image = "http://www.roblox.com/asset/?id=17265740684"
					newimage.Size = UDim2.new(1,1,1,1)
					local s = Instance.new("Sound",newgui)
					s.SoundId = "rbxassetid://6770303644"
					s.Volume = 9999999999999999999999999999999999999
