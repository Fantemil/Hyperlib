...
title.Text = ("Sans VS Chara XTREME GUI")
title.Font = ("Arcade")
...
game.Players.LocalPlayer.Character.HumanoidRootPart. CFrame = CFrame.new(-212.153717, 25.2229919, -0.725058794, 1, 0, 0, 0, 1, 0, 0, 0, 1)
end)
