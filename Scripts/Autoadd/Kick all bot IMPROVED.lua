--Made By Kosovo#3784 Credits to the original owner im not a  skid i just wanted to fix the script

--Auto kick all bot script made by kosovo#3784 edited version of the hotel elephant one and it might not work at points so noob
--Also please use an autoclicker :)
