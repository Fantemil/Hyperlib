...
TextLabel.Text = "c00lgui pocket edition v1.2"
...
ImageLabel.Image = "rbxassetid://15198649455"
...
TextLabel_2.Text = "Made by maxlovescats and reaper"
...
sp.Text = "k00pify ( not working yet )"
...
ImageLabel_2.Image = "rbxassetid://15198649455"
...
local function GYGLUI_fake_script() -- music.mus 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		music2.SoundId = "rbxassetid://1839246774"
		music2.Volume = 2
		music2:Play()
		wait(8)
		music2.Volume = 1
...
local function UFJBX_fake_script() -- message.mess 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		m.Text = "Team c00lkidd join today!"
	end)
end
	...
	script.Parent.MouseButton1Click:Connect(function()
		function exPro(root)
			for _, v in pairs(root:GetChildren()) do
				if v:IsA("Decal") and v.Texture ~= "http://www.roblox.com/asset/?id=15198649455" then
					v.Parent = nil
...
local function HODK_fake_script() -- sp.sponac 
	...
	for _,v in ipairs(game.Workspace:GetDescendants()) do
		if v:IsA("Part") then
			...
			e.Face = "Bottom"
			e.Texture="rbxassetid://160456772"
			e = Instance.new("Decal",v)
			e.Face = "Back"
			e.Texture="rbxassetid://160456772"
			e = Instance.new("Decal",v)
