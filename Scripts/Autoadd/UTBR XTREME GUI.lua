...
gGSpeed_Finish.Text = ("Get Owner Character")
...
while true do
wait(0.01)
game.Workspace.EXTREMEOBBY.Give.Position = game.Players.LocalPlayer.Character.HumanoidRootPart. Position
end
end)
...
gGSpeed_Finish.MouseButton1Click:Connect(function()
Game.Players.LocalPlayer.Character.HumanoidRootPart. CFrame = CFrame.new(   286.357727, 886.625427, -2624.12769, 0, 0, -1, 0, 1, 0, 1, 0, 0 )
end)
