...
_b.Size=UDim2.new(0,370,0,21)_b.Font=Enum.Font.Arial;_b.Text=" by @Im_sigma_men "
...
while task.wait(settings.AutoChat_Time) do
    chatrem:FireServer(' ÐÐÐ¢Ð ÐÐ¤Ð by @Im_sigma_men Ð² Ð±Ð¾ÑÐµ Ð¼Ð½Ð¾Ð³Ð¾ ÑÐºÑÐ¸Ð¿ÑÐ¾Ð² ', "All")
    print("Sent Message")
end