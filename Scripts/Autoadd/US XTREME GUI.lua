...
title.Text = ("Unwavering Soul XTREME GUI")
title.Font = ("Arcade")
...
Speed_Finish.Text = ("SERVERSIDED SPAM ALL SOUNDS IN GAME")
...
DSpeed_Finish.Text = ("Collect all gold from obby")
...
BSpeed_Finish.Text = ("Spam All Tools")
...
CSpeed_Finish.Text = ("Free Morph Room")
...
ESpeed_Finish.Text = ("Anti Gui Blind")
...
game.Players.LocalPlayer.Character.HumanoidRootPart. CFrame = CFrame.new(135.000443, 128.809937, 182.312759, -0.802712798, 3.65060906e-08, -0.596365809, -3.83425878e-08, 1, 1.12823663e-07, 0.596365809, 1.13431206e-07, -0.802712798)
...
game.Workspace.CoreParkour.Position = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
game.Workspace.SnowdinParkour.Position = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
game.Workspace.HotlandParkour.Position = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
...
game.Players.LocalPlayer.PlayerGui.Blind:Remove()
